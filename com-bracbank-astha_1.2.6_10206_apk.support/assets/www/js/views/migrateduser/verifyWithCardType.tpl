<div class="pagewrapper">
	<div class="container">
        ...
        <h3 class="text-center page-title"><%-$.i18n.t('app.login.selectverificationmode')%></h3>   
        <div class="panel panel-default" >
            <div class="panel-body">
                <form>
					<div class="form-group" id="User_id">
						<label for="username"><%-$.i18n.t('app.forgotpassword.username1')%></label>
                        <input type="text" autocomplete="off" id="username" name="username" class="form-control lenthcontrolnameval restrictCpyPst" maxlength="16" >
				...
				<div class="row">
					<div class="col-xs-6 pr5">
						<button type="button" id="migrated_home_btn" class="btn btn-default btn-block"><%-$.i18n.t('app.forgotusername.home')%></button>
					</div>
					<div class="col-xs-6 pl5">
						<a href="javascript:void(0);" id="migrated_proced_btn" class="btn btn-primary btn-block" class="text-link"><%-$.i18n.t('app.forgotpassword.proceed')%></a>
					</div>
				</div>
			</form>
        </div>
