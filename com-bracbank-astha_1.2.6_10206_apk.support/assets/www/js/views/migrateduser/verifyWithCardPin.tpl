...
<div class="pagewrapper">
    <div class="container">
		...
		<h3 class="text-center page-title"><%- $.i18n.t('app.login.verifycard') %>
	    </h3>
	   ...
	   <div class="panel-body">
			<form>
				...
				<div class="form-group" id="migNonFrequentUserAuthModeDiv"></div>			
				<div class="row">
					<div class="col-xs-6 pr5"><button type="button" class="btn btn-default btn-block" id="migrated_cancel_btn"><%-$.i18n.t('app.forgotpassword.cancel')%></button></div>
					<div class="col-xs-6 pl5"><button type="button" class="btn btn-primary btn-block" id="migrated_next_btn" data-toggle="modal"><%-$.i18n.t('app.forgotusername.next')%></button></div>
				</div>
			</form>
		</div>
	</div> 
   ...
   <form method="post">
     <div class="modal-content">
       <div class="modal-header">
         <button type="button" class="close" id="migrated_close_btn" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
         ...
         <p class="text-center small">
           <a href="javascript:void(0)" class="resend_button" id="resend_btn2">Resend OTP</a>
         </p>
     </div>
       <div class="modal-footer">
			<div class="row">
				<div class="col-xs-6 pr5">
					<button type="button" id="migrated_popup_cancel_btn" class="btn btn-primary cancel-btn btn-block" data-dismiss="modal">Cancel</button>
				</div>
				<div class="col-xs-6 pr5">
					<button type="button" onclick="javascript:void(0);" id="migrated_verify_btn" class="btn btn-default btn-block">Verify</button>
				</div>
			</div>
		</div>
   </form>
