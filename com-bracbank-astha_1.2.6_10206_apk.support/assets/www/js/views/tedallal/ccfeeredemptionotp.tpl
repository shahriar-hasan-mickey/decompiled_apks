...
%>
  		...
  		<ol class="breadcrumb cust_breadcrumb pull-left">
                   <li><a href="#/ccfeeverify"><%-$.i18n.t('app.tedallalrewards.tedallalrewards')%></a></li>
...
<input type="hidden" name="isformloaded" id="isformloaded" value="<%-soft_token%>" />
       <!-- OTP Page Starts here-->	   
							        <div id="otpId">	
						                        ...
						                        <a href="#/ccfeeverify" class="btn btn-primary btn-block"><%-$.i18n.t('app.creditcard.activatecc.cancel')%></a>
							        </div>
 </form></div><br/>
