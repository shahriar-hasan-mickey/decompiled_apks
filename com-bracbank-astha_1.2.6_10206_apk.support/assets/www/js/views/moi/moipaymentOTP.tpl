...
<input type="hidden" name="isformloaded" id="isformloaded" value="<%-soft_token%>" />
							        <div id="otpId">	
									        	...
									        	<% if(soft_token=="Y") { %>
														...
														<div class="smsotp_block" style="display: none;" id="smsDivId">
																...
																<div class="form-group">
																	...
																	<%}else{%>
																		<input type="number"  autocomplete='off'  pattern="[0-9]*" inputmode="numeric" class="form-control lenthcontrol" id="otp" name="otp" placeholder="<%-$.i18n.t('app.sadad.managebills.enterotp')%>" autocomplete="off" data-error-style="inline" maxlength="6"/>
																	<%}%>
						                        ...
						                        <input type="button" id="submit" name="button" class="btn btn-success btn-block" value="<%-$.i18n.t('app.creditcard.ccpayments.submit')%>">
						                        <a href="#/moiList" class="btn btn-primary btn-block"><%-$.i18n.t('app.creditcard.ccpayments.cancel')%></a>
							        </div>
 </form></div><br/>
