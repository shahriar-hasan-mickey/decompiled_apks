...
var dispmoiIdText = els.get("dispmoiIdrefund");
...
<div class="dtl_view">
     <form role="form">
			  ...
			  <%-$.i18n.t('app.moi.moipayments.successmessage')%><!--</br><b><u><%-$.i18n.t('app.moi.moipayments.successmessage1')%></u></b><%-$.i18n.t('app.moi.moipayments.successmessagepart')%>-->
               </div>
                ...
                <tbody>
				   <%if(dispmoiIdText[24]!=null && dispmoiIdText[24]!=""){%>
    		        	...
    		        	<%if(dispmoiIdText[20]!=null && dispmoiIdText[20]!=""){%>
		    		        <tr>	
		    		        	<td><%-$.i18n.t('app.moi.moipayments.beneficiaryid')%></td>
    		        	...
    		        	<%if(dispmoiIdText[22]!=null && dispmoiIdText[22]!=""){%>
		    		          <tr>
		    		        	...
		    		        	<td><%-$.i18n.t('app.moi.moipayments.refund_alienId')%></td>
								<%} else if(selectedBillerid == "090" && selectedsubBillerId =="013"){%>	
		    		        	<td><%-$.i18n.t('app.moi.moipayments.refund_alienId')%></td>
		    		        	<%} else if(selectedBillerid == "093" && selectedsubBillerId =="040"){%>	
		    		        	<td><%-$.i18n.t('app.moi.moipayments.violatorid')%></td>
		    		        	<%} else if(selectedBillerid == "093" && selectedsubBillerId =="041"){%>	
		    		        	<td><%-$.i18n.t('app.moi.moipayments.violatorid')%></td>
		    		        	<% }else{%>	
    		        	...
    		        	<%}%>
    		        	<%if(dispmoiIdText[23]!=null && dispmoiIdText[23]!=""){%>
		    		        <tr>	
		    		        	<td><%-$.i18n.t('app.moi.moipayments.nationalid')%></td>
		    		        	<td><%-dispmoiIdText[23]%></td>
		    		        </tr>	
    		        	<%}%>
    		        	...
    		        	<%if(dispmoiIdText[27]!=null && dispmoiIdText[27]!=""){%>
		    		        <tr>	
		    		        	<td><%-$.i18n.t('app.moi.moipayments.runalienid')%></td>
        ...
        <%if(!(emailIdCheck=="" || emailIdCheck=="null" || emailIdCheck==null || emailIdCheck=="undefined" || emailIdCheck==undefined)){%>
       	<!--	 <a href="#/moi" class="btn btn-success btn-block" id="submit"><%-$.i18n.t('app.moi.moipayments.emailadvice')%></a> -->
       	<%}%> 	 
