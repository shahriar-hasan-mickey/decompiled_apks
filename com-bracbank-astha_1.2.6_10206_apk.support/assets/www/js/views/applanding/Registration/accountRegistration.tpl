...
<div class="pagewrapper">
	...
	<div class="container">
			...
			<div class="panel-body">			
				<form>
					<div class="form-group">
						<label><%- $.i18n.t('app.registration.registerenteraccnum') %></label>
						<input type="tel" class="form-control numericlengthcontrol" id="regAccNum" maxlength="16">
					</div>
					<div class="form-group has-error">
						<p class="help-block error-message has-error" style="color:#a94442" id="regAccNumError"></p>
			 		</div>
					<div class="form-group">
						<label><%- $.i18n.t('app.registration.registerentermobnum') %></label>
						<input type="tel" class="form-control numericlengthcontrol" id="regMobNum" maxlength="16">
					</div>
					<div class="form-group has-error">
						<p class="help-block error-message has-error" style="color:#a94442" id="regMobNumError"></p>
			 		</div>
					<br>
						<div class="row">
							<div class="col-xs-6 pr5"><a href="javascript:void(0);" id="accRegCancelBtn" class="btn btn-default btn-block"><%- $.i18n.t('button.login.cancel') %></a></div>
							<div class="col-xs-6 pl5"><a href="javascript:void(0);" id="accRegValidateBtn" class="btn btn-primary btn-block"><%- $.i18n.t('button.registration.validate') %></a></div>
						</div>
				</form>
			</div>
		</div>
		...
		<div class="alert alert-info" role="alert">
				<strong>Note :</strong> 
				<ul class="small">
					<li>You will get “View Only” with registration process via account.</li>
					<li> To get the "Transactional Access" register with active debit/credit card.</li>
				</ul>
		</div>
