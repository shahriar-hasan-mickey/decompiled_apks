		...
		<div class="panel panel-default">
			<div class="panel-body">
				<% if(els.get("cardType") == "CC") { %>
					<p class="m0 small"><%- $.i18n.t('app.registration.registerentercreditcardnum') %></p>
				<% } else {%>
					<p class="m0 small"><%- $.i18n.t('app.registration.registerenterdebitcardnum') %></p>
				<% } %>
				<form>
					<div>
					...
					<div class="form-group" id="registrationAuthModeDiv"></div>
					 <div class="row">
						<div class="col-xs-8 col-xs-offset-2" id="self_reg_validatebtn">
					...
					<div class="row" style="display:none;" id="self_reg_nextbtn">
						<div class="col-xs-6 pr5"><button type="button" class="btn btn-default btn-block" id="reg_cancel_btn"><%-$.i18n.t('app.forgotpassword.cancel')%></button></div>
						<div class="col-xs-6 pl5"><button type="button" class="btn btn-primary btn-block" id="reg_next_btn" data-toggle="modal"><%-$.i18n.t('app.forgotusername.next')%></button></div>
					</div>
				</form>
			</div>
		</div>
