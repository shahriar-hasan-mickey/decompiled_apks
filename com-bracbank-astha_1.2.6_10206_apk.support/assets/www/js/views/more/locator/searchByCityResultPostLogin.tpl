<div class="pagewrapper">
	...
	<header	class="appheader">
		<div class="headerLeft">
			...
			<a href="#/locatorcitypostlogin" class="bacArr">
          			...
          			<div class="logWit small">
                		<div class="row">
                  			<div class="col-xs-6 col-sm-6 pr5">
                    			<a href="javascript:void(0);" class="username text-center active" id="listViewCity">
                      				<span class="menu_icon ico-xs userI"></span>
                      				<p class="small m0"><%-$.i18n.t('app.locator.list')%></p>
                    			</a>
                  			</div>
                  			<div class="col-xs-6 col-sm-6 pl5">
                    			<a href="javascript:void(0);" class="mPIN text-center" id="mapViewCity">
