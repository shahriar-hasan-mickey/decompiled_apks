<a href="#/preference" class="pull-left btn btn-default btn-sm back-btn"><span class="glyphicon glyphicon-chevron-left"></span></a>
                  ...
                  <ol class="breadcrumb cust_breadcrumb pull-left">
                     ...
                     <li class="active"><%-$.i18n.t('app.more.pushNotification.pushNotifyTitle')%></li>
                  </ol>
...
<%if(flag=='Y'){%>
                            <h4><%-$.i18n.t('app.more.pushNotification.pushNotifyEnableMsg')%></h4>
				  <%}else{%>  
				  	  <h4><%-$.i18n.t('app.more.pushNotification.pushNotifyDisableMsg')%></h4>  				 
				  <%}%>
                    </div>
