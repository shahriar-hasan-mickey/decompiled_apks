...
var curtempmonth = els.get("curtempmonth");
%>
  <!--Content Starts Here-->
        ...
        <div class="dtl_view">
              <table class="table table-bordered table-striped">
                   <tbody>
                      ...
                      <tr>
                          <td id="validity" ><%-$.i18n.t('app.creditcard.templimitincrease.validity')%></td>
                         		 <td  class="amt">
                         		 	<%-curtempmonth%> <%-$.i18n.t('app.creditcard.convertinstall.months')%>
                         		 </td>
