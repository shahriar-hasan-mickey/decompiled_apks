 <%
	...
	var LoginProfile = els.get("LoginProfile");
	var MaskMobile = els.get("MaskMobile");
	var devicePlatform = els.get("device.platform");
%>
 
 <a href="#/manageBeneficiaryCreditCard" id="back" class="pull-left btn btn-default btn-sm back-btn"><span class="glyphicon glyphicon-chevron-left"></span></a>
 ...
 <div class="newWiz">
       <div class="steps done"><div>1<p><%-$.i18n.t('app.creditcard.managebene.input')%></p></div></div>
       <div class="steps done"><span></span><div>2<p><%-$.i18n.t('app.creditcard.managebene.verify')%></p></div></div>
       <div class="steps"><span></span><div>3<p><%-$.i18n.t('app.creditcard.managebene.confirm')%></p></div></div>
  </div>
 <div class="dtl_view">
<form role="form">
       <!-- OTP Page Starts here-->	   
							        <div id="otpId">	
						                       ...
						                       <a href="#/manageBeneficiaryCreditCard" class="btn btn-primary btn-block"><%-$.i18n.t('app.creditcard.ccpayments.cancel')%></a>
							        </div>
 </form></div><br/>
