...
var ccDetailShortName = els.get("ccDetailShortName");
var creditCardActNo = mycreditcard[indx].accountNumber
 				creditCardActNo = DEcryptusertime(creditCardActNo);
						...
						<div class="clearfix"></div>
                          ...
                          <div id="card-fluid" class="card">
                              <div class="front" style="background:url(images/brand/card_bg.png) center 0/100% no-repeat">
                                <span class="cardflip_num"><%-creditCardActNo%></span>
                                <span class="validflip-upto"><small><%-$.i18n.t('app.creditcard.virtualcc.valid')%><br><%-$.i18n.t('app.creditcard.virtualcc.thiru')%></small> <%-exdateval%></span>
                              ...
                              <div class="back" style="background:url(images/brand/card_bg_back.png) center 0/100% no-repeat">
                                <p class="cvvflip-block"><span class="cvvflip-label">CVV</span><span class="cvv-num"><%-cvvResp%></span></p>
                              </div>
                           </div>
