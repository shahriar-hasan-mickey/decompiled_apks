<%
	...
	console.log("getactcode.."+getactcode);
 	...
 	var ccno=els.get("creditCardmaskAcctNo");
%>
 <!--Content Starts Here-->
            ...
            <!--Step Control Ends Here-->
                  <!--Breadcrumb Ends Here-->
                                ...
                                <h4><%-$.i18n.t('app.creditcard.managebene.success')%></h4>
                               <p><%-$.i18n.t('app.creditcard.managebene.activatecall')%>:+966 9200 13323.</p></div>
