...
var eppccminlimit = els.get("eppccminlmt");
		...
		var eppeligiblecardflag = els.get("eppeligiblecardflagg");
%>
						...
						<ol class="breadcrumb cust_breadcrumb pull-left">
							...
							<li class="active"><%-$.i18n.t('app.creditcard.unbilled.unbilled')%></li>
						</ol>
...
<li class="cr">
  ...
  <div class="amt">
	...
	<li class="dr" id="convertemi" data-index="<%-index%>">
		<%if(eppeligiblecardflag == 'Yes' && data.eppflag  != 'Y' && parseInt(availableCreditLimit) >= parseInt(eppccminlimit) && parseInt(data.transactionAmount) >= parseInt(ccmintranslmt)){%>
