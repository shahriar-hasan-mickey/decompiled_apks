...
<%if(creditusageflag=='Y'){%>
 ...
 <div class="clearfix"></div>
              ...
              <div class="newWiz">
							...
							<span class="msg"><%-$.i18n.t('app.creditcard.convertinstall.transselccusage')%></span>
						  </div>
                     <!--Billpay Starts Here-->
                     <form role="form">
            ...
            <%if(data.ctrlfetcherrorcode!='MSI-VP-1005'){%>
               ...
               <div    id="showDateInputStart" data-index="<%-index%>" class="form-group  has-feedback required"  style="display:none">
      <% if ( devicePlatform == "Android" ) { %>
                          <input type="text" autocomplete='off' data-index="<%-index%>" class="form-control nativedatepicker" id="startDate" name="startDate"  placeholder="<%-$.i18n.t('app.transfer.standinginstruction.start')%>">
        <%}else{%>
                          <input type="text" autocomplete='off' data-index="<%-index%>" class="form-control nativedatepicker" id="startDate" name="startDate" placeholder="<%-$.i18n.t('app.transfer.standinginstruction.start')%>" readonly>
        <%}%>
              ...
              <div id="errorFromDatePast<%-index%>" style="display:none">
                <p class="help-block error-message"><font color="#A94442"><%-$.i18n.t('app.creditcard.cardusagecontrol.errorFromDatePast')%></font></p>
                        ...
                        <div  id="showDateInputEnd" data-index="<%-index%>" class="form-group  has-feedback required"  style="display:none">
      <% if ( devicePlatform == "Android" ) { %>
                          <input type="text" autocomplete='off' data-index="<%-index%>" class="form-control nativedatepicker" id="endDate" name="endDate" placeholder="<%-$.i18n.t('app.transfer.standinginstruction.end')%>">
        <%}else{%>
                          <input type="text" autocomplete='off' data-index="<%-index%>" class="form-control nativedatepicker" id="endDate" name="endDate" placeholder="<%-$.i18n.t('app.transfer.standinginstruction.end')%>" readonly>
        <%}%>
                          <span class="glyphicon glyphicon-calendar form-control-feedback"></span>
              ...
              <div id="errorToDateGreater<%-index%>" style="display:none">
				...
				<a  href="#/creditcard" class="btn btn-primary btn-block" ><%-$.i18n.t('app.requests.homefinance.cancel')%> </a>
					 ...
					 <%}else if ( ccusagecontrolfetchDTO==null||ccusagecontrolfetchDTO==''||ccusagecontrolfetchDTO==undefined){%>
							...
							<br/><br/>
								<a  href="#/creditcard" class="btn btn-success btn-sm  btn-block" type="button"><%-$.i18n.t('app.login.backtohome')%></a>
					 <%}else{%>
						 	<div class="alert alert-info">
