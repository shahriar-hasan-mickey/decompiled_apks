            		...
            		<div class="radiobox">
            			<%if(menuList.length > 0) { %>
        					<% _.each(menuList,function(data,index){ %>
		                		<div class="radio">
		                  			<label>
		                    			<input type="radio" name="choice" id="<%- data.id%>" code="<%- data.code%>" value="<%- data.description%>">
		                				<div class="box">
			 		...
			 		<div class="clearfix"></div><br>
       				<div class="row">
         				<div class="col-xs-8 col-xs-offset-2">
             				<input type="button" id="viewBillPay_NextBtn_list" class="btn btn-primary btn-block" value="Next">
         				</div>
       				</div>
        		</form>                        
     		</section>	
