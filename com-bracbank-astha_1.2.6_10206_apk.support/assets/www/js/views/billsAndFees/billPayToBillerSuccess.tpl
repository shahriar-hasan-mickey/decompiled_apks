<%
    ...
    els.set("billpayToBillerDispValue",tDataValue);
%>
                	...
                	<div class="dTable-middle">
                    	<div class="container">
                        	<div class="ani-slideup animation-in">
								...
								<%if(els.get("commencementDate")!= ""){%>
								<!--<p class="text-center">
                                    <strong> Commencement Date <%- els.get("commencementDate")%></strong>
                                </p>-->
								<%}%>

								<%if(els.get("dueDate")!= ""){%>
								<!--<p class="text-center">
                                    <strong> Due Date <%- els.get("dueDate")%></strong>
                                </p>-->
								<%}%>
								...
								<% if(!isNull(els.get("billerDisplayValue"))) { %>
									<div class="alert alert-info small" role="alert">
										<small>
											...
											Note: <%- els.get("billerDisplayValue") %> 
											<a href="javascript:void(0);" id="bill_tobene_trans" class="small btn btn-xs btn-primary ">Transaction History</a>
										</small>
									</div>
								<% } %>
								...
								<div class="row">
									<div class="col-xs-6 pr5">
										<a href="javascript:void(0);" id="billpayToBillerDownload" class="btn btn-primary cancel-btn btn-block"><span class="fa fa-download"></span> Download </a>
									</div>
                                ...
                                <div class="clearfix"></div>
                                <br/>
                                <div class="class="col-xs-8 col-xs-offset-2">
                                	<button type="button" class="btn btn-primary cancel-btn btn-block" id="billPayTobene_MakeAnotherPay"><%-$.i18n.t('app.transferss.makeanothertransfer')%></a>
                        			<br/>
                        		</div>
                            	<div class="clearfix"></div>
                            	<br/>
