<%
    ...
    if(!isNull(qrDispFormDataBill)){
        var tDataKey = Object.keys(qrDispFormDataBill);
	    var tDataValue = Object.values(qrDispFormDataBill);
	...
	if(!isNull(qrBillFormDataBill)){
        var bDataKey = Object.keys(qrBillFormDataBill);
	    var bDataValue = Object.values(qrBillFormDataBill);
    ...
    if(!isNull(qrMerchantFormDataBill)){
        var mDataKey = Object.keys(qrMerchantFormDataBill);
	    var mDataValue = Object.values(qrMerchantFormDataBill);
...
<div class="pagewrapper">
                    ...
                    <div class="dTable-middle">
                        <div class="container">
                            ...
                            <div class="ani-slideup animation-in">
								...
								<div class="panel-group qr_confirm_accordion" id="accordion" role="tablist" aria-multiselectable="true">
									<div class="panel panel-default">
										...
										<div id="collapseOne" class="collapsePanel panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
											<div class="panel-body">
												...
												<% if(!isNull(qrBillFormDataBill) && qrBillFormDataBill.length > 0 ){ %>													
													<h5>Bill Detail</h5>
													<table class="table confirm_table">
                                ...
                                <div class="row">
									<div class="col-xs-6 pr5">
										<a href="javascript:void(0);" class="btn btn-primary cancel-btn btn-block" id="bkashqrPayDownload"><span class="fa fa-download"></span> <%-$.i18n.t('app.qrcode.download')%> </a>    
									</div>
                                ...
                                <div class="row">                                    
                                    <div class="col-xs-8 col-xs-offset-2">
										<button type="button" class="btn btn-primary cancel-btn btn-block scan_pay" id="bkash_qr_MakeAnotherTransfer">
										<span class="fa fa-share"></span> <%-$.i18n.t('app.qrcode.makeanother')%></button>  
                                    </div>
                                </div>
								<div class="clearfix"></div>
								<br/>
    ...
    <div class="footMenu footer_confirm">
        ...
        <a href="javascript:void(0);" class="scan_pay active"><span class="menu_icon ico-xs qrcode"></span><%-$.i18n.t('app.qrcode.scanandpay')%></a>
    </div>
</div>
