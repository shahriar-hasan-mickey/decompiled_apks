                            ...
                            <div class="ani-slideup animation-in">
                                ...
                                <div class="row">
									<div class="col-xs-6 pr5">
										<a href="javascript:void(0);" class="btn btn-primary cancel-btn btn-block" id="qrPayDownload"><span class="fa fa-download"></span> <%-$.i18n.t('app.qrcode.download')%> </a>    
									</div>
                                ...
                                <div class="row">                                    
                                    <div class="col-xs-8 col-xs-offset-2">
										<button type="button" class="btn btn-primary cancel-btn btn-block scan_pay" id="qr_MakeAnotherTransfer">
