                ...
                <form> <!-- form Starts here-->
                  <fieldset> <!-- fieldset Starts here-->
                    ...
                    <div class="alert alert-warning ">
                        ...
                        <input type="button" class="btn btn-secondary btn-block" id="mpinaskyes" value="<%-$.i18n.t('app.mpin.yes')%>" />
                        <input type="button" id="mpinaskno" class="btn btn-primary btn-block" value="<%-$.i18n.t('app.mpin.no')%>"/>
