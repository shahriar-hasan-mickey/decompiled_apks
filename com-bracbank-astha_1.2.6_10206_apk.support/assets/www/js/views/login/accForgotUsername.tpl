   ...
   <div class="container">
      <h1 class="lgn-logo animation-in">
        <span></span>
	  	...
	  	<% if(els.get("isforgotUsername") == "true") { %>
			...
			<div class="panel-body">
				<form>
					...
					<div class="row">
						...
						<div class="col-xs-6 pl5" id="forgot_user_validateBtnDiv"><button type="button" id="forgotUsername_validate_btn" class="btn btn-primary btn-block"><%-$.i18n.t('app.forgotusername.validate')%></button></div>
