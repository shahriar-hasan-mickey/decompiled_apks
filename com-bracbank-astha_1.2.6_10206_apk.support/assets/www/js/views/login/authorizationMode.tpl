...
<div class="pagewrapper">
	<nav class="clearfix">
		<ol class="cd-breadcrumb triangle custom-icons">
			...
			<li class="current"><span class="clr">2</span> <%-$.i18n.t('app.login.modeofauthheader')%></li>
		</ol>
	  </nav>
            	...
            	<br />
               	<div class="panel panel-default">
      				<div class="panel-body">
                    	<p class="small"><%-$.i18n.t('app.login.authmodelabel')%></p>
                      	<form>
        					<div class="custRadio">
                          		<div class="radio">
                            		<label>
                          			...
                          			<div class="row">
                                		<div class="col-xs-8">
											<span style="color:#999999;" id="email_auth"><%- email%></span>
                                     		<!--<input autocomplete='off' class="form-control" style="border-bottom: none !important;" id="email_auth" name="email_auth" type="email" value="<%- els.get("emailId")%>" readonly="readonly" placeholder="<%-$.i18n.t('app.login.enteremail')%>">-->
                                		</div>
                                		<!--<div class="col-xs-4">
                                    		<button class="btn btn-primary btn-block" id="edit" type="button" style="display: inline-block; font-size: 11px;"><%-$.i18n.t('button.login.edit')%></button>
                                    		<button class="btn btn-primary btn-block" id="save" type="button" style="display: none; font-size: 11px;"><%-$.i18n.t('button.login.confirm')%></button>
                                		</div>-->
                              		</div>
                    		...
                    		<div class="custRadio">
        			  		...
        			  		<div class="row">
        						...
        						<div class="col-xs-6 pl5"><button type="button" class="btn btn-primary btn-block" id="next_btn" data-toggle="modal"><%-$.i18n.t('button.registration.next')%></button></div>
        			  		</div>
        				</form>
                  	</div>
            	</div>
            	...
            	<form>
                	<div class="modal-content">
                    	...
                    	<div class="modal-footer">
                    		<button type="button" class="btn btn-default btn-block otp_done" id="verify_btn"><%- $.i18n.t('button.registration.verify') %></button>
                    	</div>
                	</div>
                </form>	
            </div>
