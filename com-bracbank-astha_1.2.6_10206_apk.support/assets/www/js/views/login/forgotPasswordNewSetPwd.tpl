		...
		<div class="panel panel-default">
			<div class="panel-body">					
				...
				<div class="form-group passInput">
					<input id="forgotPasswordUsername" autocomplete='off' name="forgotPasswordUsername" type="text" class="form-control alphanumericlengthcontrol" maxlength="20" value="<%- els.get("userName")%>" disabled/>
				</div>
				...
				<div class="form-group passInput">
					...
					<label for="confpassword"><%-$.i18n.t('app.forgotpassword.confirmpassword')%></label>
			 		 ...
			 		 <div class="form-group" id="forgotPassword_AuthModeDiv"></div>
                  	
                  	<div class="row">
	                    <div class="col-xs-6 pr5"><button type="button" id="forgotPwd_cancel_btn" class="btn btn-default btn-block" onClick="javascript:void(0);"><%-$.i18n.t('app.forgotusername.cancel')%></button></div>
	                	<div class="col-xs-6 pl5"><button type="button" id="forgotPwd_next_btn" class="btn btn-primary btn-block"><%-$.i18n.t('button.login.submit')%></button></div>
                  	</div>				  
			    </form>
			</div>
		</div>
