			     	...
			     	<div class="dTable-middle">
				        <div class="container">
				      	...
				      	<div class="ani-slideup animation-in">
				            <p class="text-center">Your Mode of Authorization was successfully changed from <%- els.get("oldAuthMode")%> to <%- els.get("newAuthModeSR")%>.</p>
				            <div class="col-xs-12 text-center">
                             	<button type="button" id="authManagementSuccess_OKBtn" class="btn btn-default btn-block">OK</button>
                            </div>
				        </div>
			        </div>
	        	</div>
