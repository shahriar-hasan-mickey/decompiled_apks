<!--Appwrapper Starts Here-->
  ...
  <div class="headerLeft">
    <a href="#/statementrequest" class="bacArr">
              ...
              <span class="menu_icon2 ico1x verify"></span>					
                    ...
                    <ul class="list-unstyled list-nobrd">
                        <li class="list-group-item">
                            <label><%-$.i18n.t('app.service.producttype')%></label>
                            <p>Current and Savings Accounts</p>
                        </li>

                        <li class="list-group-item">
                            <label><%-$.i18n.t('app.service.accountcardnumber')%></label>
                            <p>87541254863</p>
                        </li>
                        <li class="list-group-item">
                    ...
                    <div class="row">
                        <div class="col-xs-6 pr5">
                            <button type="button" class="btn btn-default btn-block" onClick="location.href='#/statementrequest'"><%-$.i18n.t('app.service.cancel')%></button>
                        </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              <div class="row">
                                  ...
                                  <div class="col-xs-6 pl5">
                                    <button type="button" class="btn btn-default btn-block otp_done" onClick="location.href='#/statementreqsucess'"><%-$.i18n.t('app.service.verify')%></button>
                                </div>
                              </div>
                            </div>
                        </div>
