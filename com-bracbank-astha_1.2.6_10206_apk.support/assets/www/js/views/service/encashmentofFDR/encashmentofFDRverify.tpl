...
%><div class="pagewrapper" id="appwrapper">
    ...
    <header class="appheader">
        <div class="headerLeft">
            ...
            <a href="#/encashmentofFDRInit" class="bacArr">
                ...
                <form method="post" action="#">
                    ...
                    <ul class="list-unstyled list-nobrd row">
                       ...
                       <%if(!isNull(els.get("FDpreMatureIntAmt"))){%>
                            <li class="list-group-item">
                                <label>Interest Amount by Premature Rate (withholding tax + excise duty applicable)</label>
                                <p>
                                    <span class="amt">
                    ...
                    <div class="row">
                        <div class="col-xs-6 pr5">
                            <button type="button" class="btn btn-default btn-block" id="encashmentofFDRVerify_CancelBtn">Cancel</button>
                        </div>
                        <div class="col-xs-6 pl5">
                            <button type="button" class="btn btn-primary btn-block" data-toggle="modal" id="encashmentofFDRVerify_ConfirmBtn">Confirm</button>
                        </div>
                    </div>
                </form>
            </section>
