...
<div class="pagewrapper" id="appwrapper">
	...
	<header class="appheader">
		<div class="headerLeft">
			...
			<a href="#/positivepayinit" class="bacArr">
				...
				<form>
                    ...
                    <ul class="list-unstyled list-nobrd">
                        <li class="list-group-item">
                            <label>Account</label>
                            <p><%- els.get("positivePayAccNumber")%></p>
                        </li>
                        <li class="list-group-item">
                            <label>Cheque Leaf Number</label>
                            <p><%- els.get("positivePayChequeNum")%></p>
                        </li>
                        <li class="list-group-item">
                            <label>Beneficiary Name</label>
                            <p><%- els.get("positivePayBeneName")%></p>
                        </li>
                        <li class="list-group-item">
                            <label>Amount</label>
                            <p>
	                            <%- checkAmount($.formatNumber(els.get("positivePayAmount"), {format:"#,###.00", locale:"us"}))%>
                    ...
                    <div class="row">
                        <div class="col-xs-6 pr5">
                            <button type="button" class="btn btn-default btn-block" id="positivePayVerify_CancelBtn">Cancel</button>
                        </div>
                        <div class="col-xs-6 pl5">
                            <button type="button" class="btn btn-primary btn-block" id="positivePayVerify_ConfirmBtn">Confirm</button>
                        </div>
                    </div>
                </form>
        	</section>
		            ...
		            <form method="post" action="#">
		                <div class="modal-content">
		                    <div class="modal-header">
		                        <button type="button" class="close" id="positivePayVerify_OTPCloseBtn" data-dismiss="modal" aria-label="Close">
		                    ...
		                    <div class="modal-footer">
		                        <div class="row">
									<div class="col-xs-6 pr5">
										<button type="button" id="positivePayVerify_OTPCancelBtn" class="btn btn-primary cancel-btn btn-block" data-dismiss="modal">Cancel</button>
									</div>
									<div class="col-xs-6 pr5">
										<button type="button" class="btn btn-default btn-block otp_done" id="positivePayVerify_OTPVerifyBtn"><%-$.i18n.t('app.transfer.managebeneficiary.verify')%></button>
									</div>
								</div>
		                    </div>
		                </div>
