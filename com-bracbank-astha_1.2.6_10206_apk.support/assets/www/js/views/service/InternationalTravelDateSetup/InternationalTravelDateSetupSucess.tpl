<div class="pagewrapper">
  ...
  <nav>
    ...
    <div class="dTable-wrap">
      <div class="dTable-middle">
        ...
        <span class="ico-badge center-block">
          <span class="menu_icon ico-3x internationalSucc"></span>
        </span>
            </div>
            <div class="ani-slideup animation-in">
              <p class="text-center"><%-$.i18n.t('app.service.intersucess')%></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footMenu">
      ...
      <a href="../../../app/dashboard.html"><span class="menu_icon ico-xs product"></span><%-$.i18n.t('app.service.home')%></a>
      <a href="../../../app/billpay/billerType.html" class=""><span class="menu_icon ico-xs bpay"></span><%-$.i18n.t('app.service.billpay')%></a>
      <a href="../../../app/services/serviceRequest.html" class=" active "><span class="menu_icon ico-xs request"></span><%-$.i18n.t('app.service.services')%></a>
    </div>
  </div><!-- / pagewrapper-->