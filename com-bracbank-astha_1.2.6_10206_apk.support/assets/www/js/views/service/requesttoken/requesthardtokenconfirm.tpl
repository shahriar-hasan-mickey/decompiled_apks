...
<nav>
    ...
    <div class="dTable-wrap">
      ...
      <div class="ani-slideup animation-in">
            <p class="text-center"><%-$.i18n.t('app.service.hardtokenrequest')%></p>
            <div class="clearfix"></div><br>
            <div class="row">
              <div class="col-xs-12 text-center"><button type="button" id="okbtn" class="btn btn-default btn-block" onClick="javascript:void(0);"><%-$.i18n.t('app.service.ok')%></button></div>
            </div>
          </div>
          </div>
        </div>
            ...
            <div class="footMenu footer_confirm">
              ...
              <a href="javascript:void(0);"><span class="menu_icon ico-xs transfer"></span><%-$.i18n.t('app.wealth.fntransfer')%></a>
