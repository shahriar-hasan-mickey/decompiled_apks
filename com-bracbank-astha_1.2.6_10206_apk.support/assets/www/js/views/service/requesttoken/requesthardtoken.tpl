...
<div class="pagewrapper" id="appwrapper" >
  ...
  <h4><%-$.i18n.t('app.service.requesthardtoken')%></h4>
        ...
        <div class="logWit small">
          ...
          <div class="form-group">
            <label for="branch"><%-$.i18n.t('app.service.selectbranch')%></label>
       
        				
        				<select name="branch" id="branch" class="form-control">
                        		<option value=""  selected="selected"><%-$.i18n.t('app.service.selectbarnch')%></option>
                            	<% if ( branchList.length > 0 ) { %>
			        				<% _.each(branchList,function(data){ %>
			        					<p>
          ...
          <div class="form-group has-error">
           ...
           <div class="form-group">
             ...
             <select id="fromAccntreq" class="form-control">
           ...
           <div class="form-group">
             ...
             <div class="row">
 				<div class="col-xs-7 pr5">
   					<span class="amt small"><%- tokenHardCharges%> BDT</span> 
 				</div>
			</div>
           </div><!-- / form-group-->
           <div class="form-group">
