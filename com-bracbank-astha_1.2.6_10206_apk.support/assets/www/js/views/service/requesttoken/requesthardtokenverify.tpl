<%
	...
	var branchList = els.get("branch");
	var tokenHardCharges = els.get("tokenHardCharges");
...
<!--Appwrapper Starts Here-->
  ...
  <div class="headerLeft">
    <a href="#/requesthardtoken" class="bacArr">
      <i class="fa fa-angle-left" aria-hidden="true"></i>
    </a>
  </div>
  <h4><%-$.i18n.t('app.service.hardreview')%></h4>
              ...
              <span class="menu_icon2 ico1x verify"></span>					
                    ...
                    <ul class="list-unstyled list-nobrd">
                        ...
                        <li class="list-group-item">
                            ...
                            <p>
                                <span class="amt small"><%- tokenHardCharges %>
                                </span>
                            </p>
                        </li>
                    </ul>
...
<button type="button" class="btn btn-default btn-block" onClick="location.href='#/requesthardtoken'"><%-$.i18n.t('app.service.cancel')%></button>
                        </div>
                        <div class="col-xs-6 pl5">
                            <button type="button" class="btn btn-primary btn-block" id="conbtnreq"><%-$.i18n.t('app.service.confirm')%></button>
                        </div>
                    </div>
                </form>
            </section>
