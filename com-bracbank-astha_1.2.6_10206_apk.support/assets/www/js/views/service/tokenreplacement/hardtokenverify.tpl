<%
	...
	var charges = els.get("tokenHardCharges");
	var frmacnt  = els.get("frmacnt");
	var branch  = els.get("branch");
	var rplcReason  = els.get("rplcReason");
%>
<div class="pagewrapper" id="appwrapper" >
	<header class="appheader">
  		<div class="headerLeft">
    		<a href="#/hardtoken" class="bacArr">
      			<i class="fa fa-angle-left" aria-hidden="true"></i>
			</a>
  		</div>
  		<h4><%-$.i18n.t('app.service.hardtokenreplacementreview')%></h4>
	</header>
				...
				<form> 
					...
					<ul class="list-unstyled list-nobrd">
				  		<li class="list-group-item">
					  		<label><%-$.i18n.t('app.service.branch')%></label>
					  		<p><%- branch%></p>
				  		</li>
				  		<li class="list-group-item">
			   		...
			   		<div class="row">
				 		<div class="col-xs-6 pr5"><button type="button" id="cancel" class="btn btn-default btn-block"><%-$.i18n.t('app.service.cancel')%></button></div>
				 		<div class="col-xs-6 pl5"><button type="button" id="confirmBtn" class="btn btn-primary btn-block"><%-$.i18n.t('app.service.confirm')%></button></div>
			   		</div>				
				</form>
			</section>
			...
			<div class="modal fade modernPOP" id="verify" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				...
				<form method="post" action="#">
						<div class="modal-content">
								...
								<button type="button" id="verifyBtn" class="btn btn-default btn-block otp_done" onClick="javascript:void(0);"><%-$.i18n.t('app.service.verify')%></button>
								</div>
						</div>
					</form>	
				</div>
