...
<div class="pagewrapper" id="appwrapper" >
	<header class="appheader">
  		...
  		<h4><%-$.i18n.t('app.service.hardtokenreplacement')%></h4>
	</header>
        		...
        		<form>
        			<div class="logWit small">
          				<div class="row">
            				...
            				<div class="col-xs-6 col-sm-6 pl5">
              					<a href="#/softtoken" class="text-center">
    				...
    				<label for="acc"><%-$.i18n.t('app.service.fromaccount')%></label>
           			<div class="form-group">
             			<select id="fromAccntHT" class="form-control">
          			...
          			<div class="form-group">
        				<select id="branch" class="form-control">
        					...
        					<%_.each(branchlist,function(data){ %>
           						<option value="<%- data.description%>" id="<%- data.code%>"><%- data.description%></option>
           					<%});%>
        				</select>             
      				</div>
      				<div class="form-group has-error">
