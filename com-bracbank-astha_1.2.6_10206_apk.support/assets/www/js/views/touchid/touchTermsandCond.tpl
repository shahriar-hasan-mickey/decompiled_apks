                ...
                <form >
                  ...
                  <fieldset> <!-- fieldset Starts here-->
                    <div class="alert alert-warning ">
                        <p><strong><%-$.i18n.t('app.touchid.touchTermsTitle')%></strong><br/>
                        <%-$.i18n.t('app.touchid.touchTermsText')%>
                        </p>
                    </div>
                    
                        <input type="button" id="regAgree" class="btn btn-success btn-block"  value="<%-$.i18n.t('app.touchid.touchTermsAgree')%>" />
