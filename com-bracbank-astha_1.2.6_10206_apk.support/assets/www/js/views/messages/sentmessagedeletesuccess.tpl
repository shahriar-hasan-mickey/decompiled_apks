                 ...
                 <!-- Breadcrumb Starts Here -->
                  ...
                  <!-- Breadcrumb Ends Here -->
	                       <div class="dtl_view">
								<form role="form">
									<div class="alert alert-success text-center"><%-$.i18n.t('app.more.messagecentre.sentmsgdeletesuccess')%></div><br/>
								</form>
							</div>
	                        	<a  class="btn btn-success btn-block" id="submit"><%-$.i18n.t('app.transfer.standinginstruction.home')%></a>
                  <br/>
