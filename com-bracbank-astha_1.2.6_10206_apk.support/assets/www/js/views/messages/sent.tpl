						 ...
						 <% if ( messages.length > 0 ) { %>
                              ...
                              <div class="btn-group">
								...
								<ul>
									<% _.each(messages,function(data,index){ %>
		                               <li>
											<a href="#/sentmessage/<%-index%>">
		                                      <div class="d_msg">
													<p class="type">
		                                                <label class="checkinput" data="<%-data.id %>"><input type="checkbox" class="check-hidden" value="<%-data.id %>"></label>
		                                                <span class="pull-left"><%-data.messageTo %> <br/><span class="des"><%-data.messageSubject %></span></span>
							...
							<% } else { %>
										<div class="alert alert-info">  
					                    	<h4><%-$.i18n.t('app.more.messagecentre.senditemsnull')%></h4>
					                    </div>
							<% } %>
