<%
	...
	els.set("ownCardDispValue",tDataValue);
                        ...
                        <div class="dTable-middle">
                            <div class="container">
                                ...
                                <div class="ani-slideup animation-in">
                                    ...
                                    <!--<p class="text-center"><%-$.i18n.t('app.transferss.refer')%></p>
                                    <p class="text-center">
                            ...
                            <div class="clearfix"></div>
                                <div class="row">
                                        <div class="col-xs-6 pr5">
                                            <a href="javascript:void(0);" id="ownCardTRansDownload" class="btn btn-primary cancel-btn btn-block"><span class="fa fa-download"></span> Download </a>
                                        </div>
                            ...
                            <div class="clearfix"></div>
                                    ...
                                    <br/>
 									...
 									<div class="col-xs-8 col-xs-offset-2">                                           
 									 	<button type="button" id="OwnCard_MakeAnotherTransfer" class="btn btn-primary cancel-btn btn-block"><%-$.i18n.t('app.transferss.makeanothertransfer')%></button>
                                    </div>
                                    <div class="clearfix"></div>
                                    <br/>
                                </div>
