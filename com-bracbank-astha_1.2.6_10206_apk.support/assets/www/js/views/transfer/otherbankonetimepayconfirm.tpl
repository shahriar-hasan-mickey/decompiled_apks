...
<%
	...
	els.set("otherOneOffDispValue",tDataValue);
                            ...
                            <div class="clearfix"></div>
                                <div class="row">
                                        <div class="col-xs-6 pr5">
                                             <a href="javascript:void(0);" id="otherbankOneOffTransDownload" class="btn btn-primary cancel-btn btn-block"><span class="fa fa-download"></span> Download </a>
                                        </div>
                             ...
                             <br>
                                    <div class="row">
                                        <div class="col-xs-8 col-xs-offset-2">
                                            <button type="button" class="btn btn-primary cancel-btn btn-block" id="OB_OneTime_AddAsBene"><%-$.i18n.t('app.transferss.addasbene')%></a>
                                       		<br/>
                                        </div>
                                        <br>
