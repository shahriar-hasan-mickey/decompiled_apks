...
<div class="pagewrapper" id="appwrapper" >
	...
	<header class="appheader">
  		<div class="headerLeft">
    		...
    		<a href="#/binimoybeneselect" class="bacArr">
		...
		<div class="contentwrap">
		    <section class="content" id="recent_transactions">
				<div class="form-group">
					...
					<a style="outline:none;" href="javascript:void(0)" class="acc_link" id="directPayFromAcc"  data-toggle="modal" data-target="#card_account"><div id="seltpayval" style="width:90%;height:5px;">Select Account</div><span class="glyphicon glyphicon-triangle-bottom pull-right" aria-hidden="true"></span></a> 
				...
				<div class="form-group has-error">
				 ...
				 <div class="form-group">
                    ...
                    <input type="text" id="directPayInitToVID" class="form-control alphanumericlengthcontrol" value="" maxlength="24">
                ...
                <div class="form-group has-error">
					<p class="help-block error-message has-error" style="color:#a94442" id="vidNullError"></p>
				</div>
				
				<div class="form-group">
                    <label for="reason">Alias </label>
                    <input type="text" id="directPayAliasName" class="form-control alphanumericlengthcontrol" value="" maxlength="24">
                </div>
                <div class="form-group has-error">
					<p class="help-block error-message has-error" style="color:#a94442" id="aliasNameNullErr"></p>
				</div>
                
                <label for="amt"> Amount <span class="mandi">*</span></label>
                <div class="input-group">
                    <input type="tel" class="form-control numericlengthcontrol" id="directPayAmount" onkeyup="withoutstartZero(event,'directPayAmount')" data-type="currency" pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" maxlength="20">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="directPayRemarks" class="form-control inputalphanumericlengthcontrol" value="" maxlength="24">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="directPayRefID" class="form-control inputalphanumericlengthcontrol" value="">
                </div>
				<div class="form-group has-error">
					<p class="help-block error-message has-error" style="color:#a94442" id="referenceNullErr"></p>
				</div>
             	<div class="form-group">
                 	<label class="check-label">
                    	<input type="checkbox" name="transfer" id="binimoyDPTandC"> I agree to <a href="javascript:void(0);" id="binimoyDPTAndCPopup" data-target="#termsandcond">Terms &amp; Condition</a>
                      	<span class="checkmark1"></span>
                	</label>
              	</div>
              	<div class="form-group has-error">
					<p class="help-block error-message has-error" style="color:#a94442" id="binimoyDPTandCErr"></p>
				</div>
				<br/>
				<div class="row">
                    <div class="col-xs-6 pr5">
                        <button type="button" class="btn btn-default btn-block" id="directPayInitCancelBtn">Cancel</button>
                    </div>
                    <div class="col-xs-6 pl5">
                        <button type="button" class="btn btn-primary btn-block" id="directPayInitProceedBtn">Next</button>
                    </div>
            	</div>
		                      ...
		                      <h4>Select Account/Card</h4>
					            <div class="qr_acc_outer">
					                ...
					                <ul class="list-unstyled">
					                    ...
					                    <li class="list-group-item acccardnum_directPay" acctype="CASA" frName="<%-data.productName%>" value="<%- data.id%>" Accide="<%- data.id%>" id="<%- index%>" data="<%- data.currencyCode%>" accNum="<%-data.accountNumber%>">
