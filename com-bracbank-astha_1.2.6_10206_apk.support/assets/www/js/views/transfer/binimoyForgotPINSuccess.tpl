                        ...
                        <div class="container" style="padding-left:0; padding-right:0;">    
                            ...
                            <div class="ani-slideup animation-in">
                                ...
                                <div class="text-center">
                                	<p>Your BINIMOY PIN has been changed successfully.</p>
                                    <br/>
                                    <div class="clearfix"></div>
									<div class="row">                                    
										<div class="col-xs-6 col-xs-offset-3 text-center">
											<a href="javascript:void(0);" class="btn btn-primary cancel-btn btn-block" id="binimoyForgotPINSuccessBackBtn"><span class="fa fa-chevron-left"></span> Back </a>
										</div>
						 			</div>
            						<br/>
                                </div>
