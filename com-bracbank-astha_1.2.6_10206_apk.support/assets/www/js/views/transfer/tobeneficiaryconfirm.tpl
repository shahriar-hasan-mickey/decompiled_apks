<%
	...
	els.set("withinToBeneDispValue",tDataValue);	
                ...
                <div class="clearfix"></div>
                                <div class="row">
                                        <div class="col-xs-6 pr5">
                                              <a href="javascript:void(0);" id="withinToBeneTransDownload" class="btn btn-primary cancel-btn btn-block"><span class="fa fa-download"></span> Download </a>
                                        </div>
                        	...
                        	<div class="col-xs-8 col-xs-offset-2">
                         		 <button type="button" class="btn btn-primary cancel-btn btn-block" id="WithinBank_ToBene_MakeAnotherTransfer"><%-$.i18n.t('app.transferss.makeanothertransfer')%> </button >
                    			<br/>
                        	</div>
						  	<div class="clearfix"></div>
						  	<br/>
