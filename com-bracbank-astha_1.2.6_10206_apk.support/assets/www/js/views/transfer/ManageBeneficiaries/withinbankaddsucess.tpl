						...
						<div class="container" style="padding-left:0; padding-right:0;">
							...
							<div class="ani-slideup animation-in">
								...
								<div class="text-center">
									<!--<p><span class="menu_icon2 beneSucs"></span></p>-->
									<p><%-$.i18n.t('app.transfer.managebeneficiary.sucessmsg')%> <strong>"<%- els.get("nickname")%>"</strong> <%-$.i18n.t('app.transfer.managebeneficiary.sucessmsg1')%></p>	
									<% if(!isNull(els.get("coolingPeriod"))) { %>
										<p><%- els.get("coolingPeriod")%></p>
									<% } %>
									<br/>
									<!--<div class="addPic"><img src="images/common/user_default1.png" alt="Profile Image">
										<i class="fa fa-plus" aria-hidden="true"></i>                
										<input id="exampleInputFile" type="file">
									</div>	
									<span class="addPicTex small"><%-$.i18n.t('app.transfer.managebeneficiary.addphoto')%> <strong><%- els.get("nickname")%></strong></span>
									<p>
										<input id="fav" class="icon-fav user-success" type="checkbox">
										<label for="fav" class="bene-fav"><span class="heart"></span> <%-$.i18n.t('app.transfer.managebeneficiary.makeasfavourite')%> </label>
									</p>-->
									<div class="clearfix"></div>
									<div class="row">
										<div class="col-xs-6 pr5"><button type="button" id="add_bene_success" class="btn btn-default btn-block"><%-$.i18n.t('app.transfer.managebeneficiary.addbene')%></button></div>
										<div class="col-xs-6 pl5"><button type="button" id="view_bene_success" class="btn btn-default btn-block"><%-$.i18n.t('app.transfer.managebeneficiary.viewbeneficiaries')%></button></div>
									</div><br/>
									<div class="row">
										<div class="col-xs-3 pr5"></div>
										<div class="col-xs-6 pr5"><button type="button" id="initTransfer" class="btn btn-default btn-block"><%-$.i18n.t('app.transfer.managebeneficiary.initiatetransfer')%></button></button></div>
										<div class="col-xs-3 pr5"></div>
									</div>				  
								</div>
							</div>
