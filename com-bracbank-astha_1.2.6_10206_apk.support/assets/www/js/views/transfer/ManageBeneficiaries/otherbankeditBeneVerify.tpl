...
<div class="pagewrapper" id="appwrapper" >
	...
	<header class="appheader">
		<div class="headerLeft">
			...
			<a href="#/otherbankeditbene" class="bacArr">
        		...
        		<form method="post" action="#">	
            		...
            		<div class="veriWrap">
                		<div class="media">
                    		...
                    		<div class="media-body media-middle">
                    			<%- selectedBeneDTO.firstName%>
                        		<p class="small text-muted m0"><%- selectedBeneDTO.accountNumber%></p>
                        		<%if(selectedBeneDTO.bankName !== null) { %>
                        			<p class="small text-muted"><%- selectedBeneDTO.bankName%></p>
                        		<% } %>
                    		</div>
            		...
            		<ul class="list-unstyled list-nobrd">
                		...
                		<li class="list-group-item">
                    		...
                    		<p class="small"><%- els.get("sNameEdited") %></p>
                		</li>
            		...
            		<div class="row">
                		<div class="col-xs-6 pr5">
                    		<button type="button" class="btn btn-default btn-block" id="cancelBtn"><%-$.i18n.t('app.transfer.managebeneficiary.cancel')%></button>
                		</div>
                		<div class="col-xs-6 pl5">
                    		<button type="button" id="confirm_btn" class="btn btn-primary btn-block"><%-$.i18n.t('app.transfer.managebeneficiary.confirm')%></button>
                		</div>
            		</div>    
        		</form>
    		</section>
