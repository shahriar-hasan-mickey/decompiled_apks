<%
	...
	var walletAccNum = els.get("walletAccNum");
	var walletHolderName = els.get("walletHolderName");
	var walletBeneshortName = els.get("walletBeneshortName");
	var walletMobileNum = els.get("walletMobileNum");
	var walletEmailAdd = els.get("walletEmailAdd");
	var walletRemark = els.get("walletRemark");
%>
<div class="pagewrapper" id="appwrapper" >
	...
	<header class="appheader">
		<div class="headerLeft">
			...
			<a href="#/addwalletbene" class="bacArr">
        		...
        		<form>	
            		...
            		<div class="veriWrap">
                		<div class="media">
                    		<div class="media-body media-middle">
                        		<%- walletHolderName%>
                        		<p class="small text-muted m0"><%- walletAccNum%></p>
                    		</div>
            		...
            		<ul class="list-unstyled list-nobrd">
                		<li class="list-group-item">
                    		...
                    		<p><%- walletBeneshortName%></p>
                		</li>
                		<% if(!isNull(walletMobileNum)) { %>
                			<li class="list-group-item">
	                    		<label><%-$.i18n.t('app.transfer.managebeneficiary.mobilenum')%></label>
	                    		<p><%- walletMobileNum%></p>
	                		</li>
                		<% } %>
                		
                		<% if(walletEmailAdd != "" && walletEmailAdd != null) { %>
	                		<li class="list-group-item">
	                    		<label><%-$.i18n.t('app.transfer.managebeneficiary.emailaddress')%></label>
	                    		<p class="wraptext"><%-walletEmailAdd %></p>
	                		</li>
                		<% } %>
                		<% if(!isNull(walletRemark)) { %>
                 		<li class="list-group-item">
            		...
            		<div class="row">
                		<div class="col-xs-6 pr5">
                    		<button type="button" id="walletAddVerifyCancelBtn" class="btn btn-default btn-block" ><%-$.i18n.t('app.transfer.managebeneficiary.cancel')%></button>
                		</div>
                		<div class="col-xs-6 pl5">
                    		<button type="button" id="walletAddVerifyConfirmBtn" class="btn btn-primary btn-block" ><%-$.i18n.t('app.transfer.managebeneficiary.confirm')%></button>
                		</div>
        			</div>    
        		</form>
    		</section>
            		...
            		<form method="post" action="#">
                		<div class="modal-content">
                    		<div class="modal-header">
		                        <button type="button" class="close" id="wallet_add_close_btn" data-dismiss="modal" aria-label="Close">
		                     ...
		                     <div class="modal-body">
								...
								<% if(els.get("alertType") == "SMS" || els.get("alertType") == "EMAIL") { %>
									...
									<p class="text-center small">
										<a href="javascript:void(0);" class="resend_button" id="resend_btn9"><%-$.i18n.t('app.transfer.managebeneficiary.resendotp')%></a>
									</p>
								<% } %>
		                    </div>
		                    <div class="modal-footer">
		                        <div class="row">
									<div class="col-xs-6 pr5">
										<button type="button" id="walletAddOTPCancelBtn" class="btn btn-primary cancel-btn btn-block" data-dismiss="modal">Cancel</button>
									</div>
									<div class="col-xs-6 pr5">
										<button type="button" class="btn btn-default btn-block otp_done" id="walletAddOTPVerifyBtn"><%-$.i18n.t('app.transfer.managebeneficiary.verify')%></button>
									</div>
								</div>
		                    </div>
		                </div>
