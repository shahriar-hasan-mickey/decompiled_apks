      						...
      						<div class="ani-slideup animation-in">
								<br/>
		  						<div class="text-center">
			  						<p><%-$.i18n.t('app.transfer.managebeneficiary.sucessmsg')%><strong> "<%- els.get("walletBeneshortName")%>" </strong> <%-$.i18n.t('app.transfer.managebeneficiary.sucessmsg1')%></p>	
				  					<br/>
				  					<!--<div class="addPic"><img src="images/common/user_default1.png" alt="Profile Image">
										<i class="fa fa-plus" aria-hidden="true"></i>                
										<input id="exampleInputFile" type="file">
				  					</div>	
				  					<span class="addPicTex small"><%-$.i18n.t('app.transfer.managebeneficiary.addphoto')%> <strong> <%- els.get("walletBeneshortName")%> </strong></span>
		  							<p>
            						...
            						<div class="row">
              							<div class="col-xs-6 pr5"><button type="button" id="walletAddBeneSuccessBtn" class="btn btn-default btn-block"><%-$.i18n.t('app.transfer.managebeneficiary.addbene')%></button></div>
          								<div class="col-xs-6 pl5"><button type="button" class="btn btn-default btn-block" id="walletViewBeneSuccessBtn"><%-$.i18n.t('app.transfer.managebeneficiary.viewbeneficiaries')%></button></div>
            						</div>	
            						<br/>
            						<div class="row">
            							<div class="col-xs-3 pr5"></div>
            							<div class="col-xs-6 pr5"><button type="button" id="walletInitTransfer" class="btn btn-default btn-block"><%-$.i18n.t('app.transfer.managebeneficiary.initiatetransfer')%></button></div>
            							<div class="col-xs-3 pr5"></div>
            						</div>		  
        						</div>
        					</div>
