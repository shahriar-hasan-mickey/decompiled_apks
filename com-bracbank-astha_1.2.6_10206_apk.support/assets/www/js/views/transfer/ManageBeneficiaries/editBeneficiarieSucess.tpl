<div class="pagewrapper">	
					...
					<div class="dTable-middle">
						<div class="container" style="padding-left:0; padding-right:0;">
							...
							<div class="ani-slideup animation-in">
								<p class="text-center"><%-$.i18n.t('app.transfer.managebeneficiary.editsucessmsg1')%></p>
								<div class="clearfix"></div><br>
								<div class="row">
									<div class="col-xs-6 pr5"><button type="button" id="within_edit_initTransfer" class="btn btn-default btn-block"><%-$.i18n.t('app.transfer.managebeneficiary.initiatetransfer')%></button></button></div>
									<div class="col-xs-6 pl5"><button type="button" id="within_edit_view_bene_success" class="btn btn-default btn-block"><%-$.i18n.t('app.transfer.managebeneficiary.viewbeneficiaries')%></button></div>
								</div>
							</div>
						</div>
					</div>
	...
	<div class="footMenu footer_confirm">
		...
		<a href="#/transhistory"><span class="menu_icon ico-xs transactions"></span><%-$.i18n.t('app.wealth.transactions')%></a>
	</div>
</div>
