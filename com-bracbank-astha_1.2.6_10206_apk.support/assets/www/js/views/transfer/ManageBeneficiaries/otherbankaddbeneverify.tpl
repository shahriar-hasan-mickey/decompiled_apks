<%
	...
	var accName = els.get("accHolderName");
	var accNum = els.get("accntNumber");
	var bank = els.get("bankName");
    var bcode = els.get("otherbankcode");
    var brcode = els.get("otherbranchcode");
    console.log("brcode",brcode);
	var branch = els.get("benebranch");
	console.log("benebranch",branch);
	var benetype = els.get("beneType");
	var routingnum = els.get("routingNumber");
	var distName = els.get("districtName");
	var shortname = els.get("shortName");
	var email = els.get("emailAdd");
%>
<div class="pagewrapper" id="appwrapper" >
	...
	<header class="appheader">
		<div class="headerLeft">
			...
			<a href="#/otherbankaddbene" class="bacArr">
			...
			<section class="content">
		   		<form>	
              		...
              		<div class="veriWrap">
                		<div class="media">
                  			<div class="media-body media-middle">
                    			<%- accName%>
                    				<p class="small text-muted m0"><%- accNum%></p>
                    				<%if(bcode !== null) { %>
                    					<p class="small text-muted m0"><%- bank%></p>
                    				<% } %>
              				</div>
              		...
              		<ul class="list-unstyled list-nobrd">			
       				...
       				<div class="row">
		            	<div class="col-xs-6 pr5"><button type="button" class="btn btn-default btn-block" id="cancelBtn"><%-$.i18n.t('app.transfer.managebeneficiary.cancel')%></button></div>
             			<div class="col-xs-6 pl5"><button type="button" id="confirmBtn"  class="btn btn-primary btn-block"><%-$.i18n.t('app.transfer.managebeneficiary.confirm')%></button></div>
       				</div>			
          		</form>                      
       		</section>
	    				...
	    				<div class="modal-content">
	      					...
	      					<div class="modal-body">
								...
								<% if(els.get("alertType") == "SMS" || els.get("alertType") == "EMAIL") { %>
									...
									<p class="text-center small">
										<a href="javascript:void(0);" class="resend_button" id="resend_btn7"><%- $.i18n.t('app.registration.rensendotp') %></a>
									</p>
								<% } %>
	      					</div>
	      					<div class="modal-footer">
								<div class="row">
									...
									<div class="col-xs-6 pr5">
										<button type="button" id="addBeneficiary" class="btn btn-default btn-block"><%- $.i18n.t('button.registration.verify') %></button>
									</div>
								</div>
							</div>
						</div>
