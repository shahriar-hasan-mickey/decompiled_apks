<%
	...
	var accountnum=els.get("accountnum");
	var accholdername=els.get("accholdername");
	var email=els.get("email");
		...
		<div class="contentwrap">
            ...
            <div class="veriWrap">
                <div class="media">
                    ...
                    <div class="media-body media-middle">
                        <%-accholdername%>
                        <p class="small text-muted m0"><%-accountnum%></p>
            ...
            <div class="row">
                <div class="col-xs-6 pr5">
                    <button type="button" class="btn btn-default btn-block" id="edit_view_bene"><%-$.i18n.t('app.transfer.managebeneficiary.cancel')%></button>
                </div>
                <div class="col-xs-6 pl5">
                    <button type="button" class="btn btn-primary btn-block" data-toggle="modal" id="load_otp1"><%-$.i18n.t('app.transfer.managebeneficiary.confirm')%></button>
                </div>
            </div>    
        </form>
    </section>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
						...
						<% if(els.get("alertType") == "SMS" || els.get("alertType") == "EMAIL") { %>
							...
							<p class="text-center small">
								<a href="javascript:void(0)" class="resend_button" id="resend_btn5"><%-$.i18n.t('app.transfer.managebeneficiary.resendotp')%></a>
							</p>
						<% } %>
                    </div>
					<div class="modal-footer">
                        <div class="row">
							...
							<div class="col-xs-6 pr5">
								<button type="button" class="btn btn-default btn-block otp_do-ne" id="load_sucess"><%-$.i18n.t('app.transfer.managebeneficiary.verify')%></button>
							</div>
						</div>
                    </div>
                </div>
