        			...
        			<div class="dTable-middle">
          				<div class="container" style="padding-left:0; padding-right:0;">
            				...
            				<div class="ani-slideup animation-in">
              					...
              					<div class="row">
                					<div class="col-xs-6 pr5"><button type="button" id="otherbank_edit_initTransferSuccess" class="btn btn-default btn-block"><%-$.i18n.t('app.transfer.managebeneficiary.initiatetransfer')%></button></div>
									<div class="col-xs-6 pl5"><button type="button" class="btn btn-default btn-block" id="otherbank_edit_viewBeneSuccess"><%-$.i18n.t('app.transfer.managebeneficiary.viewbeneficiaries')%></button></div>
								</div>
            				</div>
        				</div>
          			</div>
