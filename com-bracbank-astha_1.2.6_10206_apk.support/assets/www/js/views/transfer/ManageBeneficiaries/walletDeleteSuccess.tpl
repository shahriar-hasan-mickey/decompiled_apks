	  						...
	  						<div class="ani-slideup animation-in">
								<br/>
					  			<div class="text-center">
									...
									<div class="row">
					  					<div class="col-xs-6 pr5"><button type="button" class="btn btn-default btn-block" id="walletAddDeleteBeneficiaryBtn">Add Beneficiary</button></div>
					  					<div class="col-xs-6 pl5"><button type="button" class="btn btn-default btn-block" id="walletViewDeleteBeneficiaryBtn">View Beneficiaries</button></div>
									</div>			  
								</div>
		  					</div>
						</div>
