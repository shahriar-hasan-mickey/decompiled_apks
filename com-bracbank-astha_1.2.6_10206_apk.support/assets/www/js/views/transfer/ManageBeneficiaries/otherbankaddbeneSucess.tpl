      						...
      						<div class="ani-slideup animation-in">
								<br/>
		  						<div class="text-center">
			  						<p><%-$.i18n.t('app.transfer.managebeneficiary.sucessmsg')%><strong> "<%- els.get("shortName")%>" </strong> <%-$.i18n.t('app.transfer.managebeneficiary.sucessmsg1')%></p>	
									...
									<% } %>
				  					...
				  					<span class="addPicTex small"><%-$.i18n.t('app.transfer.managebeneficiary.addphoto')%> <strong> <%- els.get("shortName")%> </strong></span>
		  							<p>
            						...
            						<div class="row">
              							<div class="col-xs-6 pr5"><button type="button" id="addBeneSuccess" class="btn btn-default btn-block"><%-$.i18n.t('app.transfer.managebeneficiary.addbene')%></button></button></div>
          								<div class="col-xs-6 pl5"><button type="button" class="btn btn-default btn-block" id="viewBeneSuccess"><%-$.i18n.t('app.transfer.managebeneficiary.viewbeneficiaries')%></button></div>
            						</div>	
            						<br/>
            						<div class="row">
            							<div class="col-xs-3 pr5"></div>
            							<div class="col-xs-6 pr5"><button type="button" id="initTransferSuccess" class="btn btn-default btn-block"><%-$.i18n.t('app.transfer.managebeneficiary.initiatetransfer')%></button></div>
            							<div class="col-xs-3 pr5"></div>
            						</div>		  
        						</div>
        					</div>
