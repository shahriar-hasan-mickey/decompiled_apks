...
<div class="transferHis BINIMOY">
	<% if(!isNull(RTPReceiveList) && RTPReceiveList.length > 0) { %>
		<ul class="list-unstyled">
			<% _.each(RTPReceiveList,function(data,index){ %>
		            ...
		            <a href="javascript:void(0);">
		                <div class="row">
		                    ...
		                    <div class="col-xs-5 left-col small">
		                        <p>Received RTP</p>
		                        <p class="trans_data"><span class="text-muted">From:</span> <b><%- data.senderName%></b> <span class="small"><%- data.senderVID%></span></p>
		                        <p class="trans_data"><span class="text-muted">To:</span> <b><%- els.get("profileName")%></b> <span class="small"><%- els.get("registerdDevice")%></span></p>
		                    </div>
	...
	<% } else { %>
		<p class="text-center"> You don't have any Received RTP History</p>
	<% } %>
