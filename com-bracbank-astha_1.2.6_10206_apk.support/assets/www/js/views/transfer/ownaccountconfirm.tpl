...
if(!isNull(dispFormData)){
	...
	els.set("ownAccDispValue",tDataValue);
                               ...
                               <p class="text-center"><%-$.i18n.t('app.transferss.transsucces')%></p>
                                ...
                                <div class="row">
                                        <div class="col-xs-6 pr5">
                                              <a href="javascript:void(0);" id="ownAccTransDownload" class="btn btn-primary cancel-btn btn-block"><span class="fa fa-download"></span> Download </a>  
                                        </div>
                                ...
                                <div class="col-xs-8 col-xs-offset-2">
                                 	<button type="button" id="OwnAcc_MakeAnotherTransfer" class="btn btn-primary cancel-btn btn-block"><%-$.i18n.t('app.transferss.makeanothertransfer')%></button>
                           			<br/>
                                </div>
								<div class="clearfix"></div>
                              	<br/>
