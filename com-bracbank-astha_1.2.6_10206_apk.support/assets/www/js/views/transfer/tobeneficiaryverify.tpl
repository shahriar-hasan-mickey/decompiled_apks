<%
	...
	var Fromaccno=els.get("Fromaccno");
	var paymentAmount=els.get("withinBankPaymentAmount");
    var beneficiaryDTO = els.get("beneficiaryDTO");
	var noindex1=els.get("noindex1");
	var accountNumber1=beneficiaryDTO[noindex1].accountNumber;
	var shortName1=beneficiaryDTO[noindex1].shortName;
...
<!--Appwrapper Starts Here-->
		...
		<div class="headerLeft">
			<button type="button" id="mnutoggle" class="btn btn-default mnutoggle">
				...
				<span class="icon-bar"></span>
                  ...
                  <a href="#/tobeneficiary" class="bacArr">			
    ...
    <form method="post" action="#">	
        ...
        <div class="veriWrap">
            <div class="media">
                ...
                <div class="media-body media-middle">
                    <%- els.get("fromname")%>
                    <p class="small text-muted"><%-Fromaccno%></p>
                </div>
                <div class="media-right text-right media-middle">
                    <span class="cur small text-muted"><%-els.get("fromAccCur")%> </span>
                </div>
            </div>
            <!-- / media -->
            <div class="media m0">
            ...
            <div class="media m0">
                ...
                <div class="media-body media-middle">
                    <%-shortName1%>
                    <p class="small text-muted"><%-accountNumber1%></p>
                </div>
                <div class="media-right text-right media-middle">
        ...
        <ul class="list-unstyled list-nobrd">
            ...
            <% if(els.get("fromAccCur") !== els.get("toAccCurr")) { %>
	            <li class="list-group-item">
					<label><%-$.i18n.t('app.transferss.exchangeratelabel')%></label>
					<p>
						1 <%- els.get("toAccCurr")%> = <%- checkAmount($.formatNumber(els.get("toExchangeRate"), {format:"#,###.00", locale:"us"}))%> <%- els.get("fromAccCur")%>
					</p>
				</li>
				<%if(els.get("debitAmount") != "" && els.get("debitAmount") != null) {%>
					<li class="list-group-item">
						...
						<p>
							<%- checkAmount($.formatNumber(els.get("debitAmount"), {format:"#,###.00", locale:"us"}))%> <%- els.get("fromAccCur")%>
						</p>
					</li>
				<% } %>
        ...
        <div class="row">
            ...
            <div class="col-xs-6 pl5">
                <button type="button" class="btn btn-primary btn-block" id="WB_ToBene_Verify_ConfirmBtn">TRANSFER</button>
            </div>
        </div>
        <br>
    </form>
            ...
            <form method="post" action="#">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" id="WB_ToBene_OTPCloseBtn" data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="modal-footer">
                        <div class="row">
							<div class="col-xs-6 pr5">
								<button type="button" id="WB_ToBene_OTPCancel" class="btn btn-primary cancel-btn btn-block" data-dismiss="modal">Cancel</button>
							</div>
							<div class="col-xs-6 pr5">
								<button type="button" class="btn btn-default btn-block otp_done" id="WB_ToBene_OTPVerify"><%-$.i18n.t('app.transfer.managebeneficiary.verify')%></button>
							</div>
						</div>
                    </div>
                </div>
