...
<div class="pagewrapper" id="appwrapper" >
	...
	<header class="appheader">
  		...
  		<div class="headerMiddle">
  			<h4  class="p10">BINIMOY-Forgot PIN</h4>	
  		</div>
		    ...
		    <section class="content">
				<form>
        			<div class="form-group">
            			<label for="npass">Enter New MPIN</label>
            			<div class="form-group">
                			<input type="tel" id="binimoyForgotPIN_NewPIN" name="binimoyForgotPIN_NewPIN" maxlength="6" autocomplete="off" inputmode="numeric" pattern="[0-9]*" class="numericlengthcontrol restrictCpyPst">
            			</div>
	        		</div>
	        		<div class="form-group has-error">
						<p class="help-block error-message has-error" style="color:#a94442" id="binimoyForgotPIN_NewPINErr"></p>
 					</div>
        			<div class="form-group">
            			<label for="cnpass">Confirm New MPIN</label>
        				<div class="form-group">
							<input type="tel" id="binimoyForgotPIN_ConfirmPIN" name="binimoyForgotPIN_ConfirmPIN" maxlength="6" autocomplete="off" inputmode="numeric" pattern="[0-9]*" class="numericlengthcontrol restrictCpyPst">	
       		 			</div>
    				</div>
    				<div class="form-group has-error">
						<p class="help-block error-message has-error" style="color:#a94442" id="binimoyForgotPIN_ConfirmPINErr"></p>
 					</div>
    				<div class="clearfix"></div>
    				<div id="binimoyForgotPINAuthModeDiv"></div>
    				<p>&nbsp;</p>
    				<div class="row">
        				<div class="col-xs-6 pr5">
            				<button type="button" class="btn btn-default btn-block" id="binimoyForgotPINInput_CancelBtn">Cancel</button>
        				</div>
        				<div class="col-xs-6 pl5">
            				<button type="button" class="btn btn-primary btn-block" id="binimoyForgotPINInput_ProceedBtn">Next</button>
        				</div>
    				</div>
				</form>
    		</section>
...
<script>
	$(document).ready(function() {
		$('#binimoyForgotPIN_NewPIN').pincodeInput({inputs:6,complete:function(value, e){  	
        }});

		$('#binimoyForgotPIN_ConfirmPIN').pincodeInput({inputs:6,complete:function(value, e){  	
        }});
