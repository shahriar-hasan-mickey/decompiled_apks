<%
	...
	var fromAcntId = els.get("fromAcntId");
	var toAcntInd = els.get("selectedBeneInd");
	var selectedAccountDTO = otherbene[toAcntInd];
	var otherfromname=els.get("otherfromname");
	var otherFromaccno= els.get("otherFromaccno");
	var bankbranch = els.get("branchName");
	var routingnumber = els.get("routingNo");
	var district = els.get("district");
	var paymentType = els.get("paymentType");
	var otherfromcurCode= els.get("otherfromcurCode");
	var currency =els.get("currency");
	var paymentAmount = els.get("transferAmount");
	var purposetransfer = els.get("transferReason");
	...
	var transtype = els.get("transferChannel");
...
<!--Appwrapper Starts Here-->
	...
	<header class="appheader">
		<div class="headerLeft">
			...
			<a href="javascript:void(0);" id="othertransferbackbtn"  class="bacArr">		
    ...
    <form method="post" action="#">	
        ...
        <div class="veriWrap">
            ...
            <div class="media">
                ...
                <div class="media-right media-middle text-right">
                    <span class="label label-default"><%- transtype%></span>
                </div>
            </div>
            <!-- / media -->
            <div class="media">
                ...
                <div class="media-body media-middle">
                    <%- selectedAccountDTO.firstName%>
                    <p class="small text-muted m0"><%- selectedAccountDTO.accountNumber%></p>
                    <p class="small text-muted m0"><%- selectedAccountDTO.bankName%></p>
                </div>
        ...
        <div class="clearfix"></div>
		<% if(!isNull(els.get("replyText")) && transtype != "NPSB") { %>
	   ...
	   <% } %>
        <div class="row">
           ...
           <button type="button" class="btn btn-primary btn-block" id="other_OtherBene_Verify_ConfirmBtn"><%-$.i18n.t('app.transferss.sendmoney')%></button>
        ...
        <form method="post" action="#">
            <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" id="other_OtherBene_OTPCloseBtn" data-dismiss="modal" aria-label="Close">
 ...
 <span aria-hidden="true">&times;</span>
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <div class="row">
							<div class="col-xs-6 pr5">
								<button type="button" id="other_OtherBene_OTPCancel" class="btn btn-primary cancel-btn btn-block" data-dismiss="modal">Cancel</button>
							</div>
							<div class="col-xs-6 pr5">
								<button type="button" class="btn btn-default btn-block otp_done" id="other_OtherBene_OTPVerify"><%-$.i18n.t('app.transfer.managebeneficiary.verify')%></button>
							</div>
						</div>
                    </div>
