...
<div class="pagewrapper" id="appwrapper" >
	...
	<header class="appheader">
  		<div class="headerLeft">
    		...
    		<a href="#/binimoyrtpreceivereqacceptinit" class="bacArr">
				...
				<form method="post" action="#">	
		        	...
		        	<div class="veriWrap">
		            	<div class="media">
		                	<div class="media-body media-middle">
                    			...
                    			<p class="small text-muted"> <%- els.get("registerdDevice")%> | <%- els.get("rtpReceiveAccFromAccNum")%></p>
		                	</div>
		                	<div class="media-right media-middle text-right">
		                    	<span class="cur small text-muted"><%- els.get("rtpReceiveAccFromAccCur")%></span>
		                	</div>
		            	</div>
		            	<div class="media">
		                	...
		                	<div class="media-body media-middle">
		                    	<span class="amt pos">
			                    	<%- checkAmount($.formatNumber(els.get("rtpRecReqAcc_Amount"), {format:"#,###.00", locale:"us"}))%>
		            	...
		            	<div class="media">
		                	<div class="media-body media-middle">
		                		<%- els.get("rtpRecReqAcc_ToVIDName")%>
		                    	<p class="small text-muted"> <%- els.get("rtpRecReqAcc_ToVID")%></p>
		                	</div>
		            	</div>
		        	</div>
		        	<ul class="list-unstyled list-nobrd">
		            	<!--<li class="list-group-item">
		                	<label>BINIMOY Fees</label>
		                	<p>
		                    	<span class="amt">1.
		            	...
		            	<li class="list-group-item">
		                	<label> Remarks</label>
		                	<p><%- els.get("rtpRecReqAcc_Remarks")%></p>
		            	</li>
		            	<% if(!isNull(els.get("rtpRecReqAcc_RefID"))) { %>
		            		<li class="list-group-item">
			                	<label>Reference ID</label>
			                	<p><%- els.get("rtpRecReqAcc_RefID")%></p>
			            	</li>
		        	...
		        	<div class="row">
		            	<div class="col-xs-6 pr5">
		                	<button type="button" class="btn btn-default btn-block" id="rtpRecReqAccVerify_CancelBtn">Cancel</button>
		            	</div>
		            	<div class="col-xs-6 pl5">
		                	<button type="button" class="btn btn-primary btn-block" id="rtpRecReqAccVerify_ConfirmBtn">Proceed</button>
		            	</div>
		        	</div>
		        	<br>
		    	</form>
