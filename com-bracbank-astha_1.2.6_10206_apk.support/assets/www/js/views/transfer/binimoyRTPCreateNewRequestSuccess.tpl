                            ...
                            <div class="ani-slideup animation-in">
								...
								<!--<div class="row">
                                        <div class="col-xs-6 pr5">
                                         	<a href="javascript:void(0);" id="rtpSendNewReqDownloadBtn" class="btn btn-primary cancel-btn btn-block"><span class="fa fa-download"></span> Download </a>
                                        </div>
                                        <div class="col-xs-6 pl5">
                                            <a onclick="screenshot()" class="btn btn-primary cancel-btn btn-block"><span class="fa fa-share-alt"></span> Share </a>
                                        </div>
                                </div>-->
                                <div class="row">
									<div class="col-xs-6 pr5">
										<a href="javascript:void(0);" id="rtpCreateNewReqMakeAnotherBtn" class="btn btn-primary cancel-btn btn-block">Make another </a>
									</div>
									<div class="col-xs-6 pl5">
										<a onclick="screenshot()" class="btn btn-primary cancel-btn btn-block"><span class="fa fa-share-alt"></span> Share </a>
									</div>
                            	...
                            	<!--<div class="col-xs-8 col-xs-offset-2">
                                	<button type="button" id="rtpCreateNewReqMakeAnotherBtn" class="btn btn-primary cancel-btn btn-block"><span class="fa fa-share"></span>Make Another</button>
                        			<br/>
                        		</div>-->
                            	<div class="clearfix"></div>
                            	<br/>
