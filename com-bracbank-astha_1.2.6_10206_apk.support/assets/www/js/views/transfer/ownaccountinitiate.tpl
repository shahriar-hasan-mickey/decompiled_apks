<%
	...
	var selectedAccountDTO = casaDTO[toAcntInd];
...
<div class="pagewrapper" id="appwrapper" >
	...
	<header class="appheader">
		<div class="headerLeft">
			...
			<a href="#/ownaccountselectbeneficiary" class="bacArr">
				<i class="fa fa-angle-left" aria-hidden="true"></i>
			</a>
	      </div>
	      <div class="headerMiddle">
  			<h4  class="p4"><%-$.i18n.t('app.transferss.paymentdetails')%><p class="small"><%-$.i18n.t('app.transferss.paumenttrans')%></p></h4>	
		</div>
	...
	<div class="bodywrapper">
		<div class="contentwrap">
			<section class="content">
        		<form>    
            		<div class="media payAcc">
                		...
                		<div class="media-body">
                    		...
                    		<p class="text-right small">
                        		<a href="#/ownaccounthistory" class="text-link">
            		...
            		<div class="form-group">
                 		<select name="fromaccnum" id="OwnAcc_FromAccNum" class="form-control" onchange="removeVald(this)" >
                 			<option value=""  selected="selected"><%-$.i18n.t('app.transferss.selaccnum')%></option>
                			<%_.each(casaDTO,function(data,index) { %>
                				<% if(data.accountNumber != selectedAccountDTO.accountNumber && data.ownflag == "Y") { %>
            		...
            		<div class="form-group">
                		<div class="row">
                    		<div class="col-xs-8 pr5">
								<input type="tel" autocomplete='off'  class="form-control numericlengthcontrol transferAmountClass" data-type="currency"  pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" onkeyup="withoutstartZero(event,'ownpaymentAmount')" id="ownpaymentAmount" name="ownpaymentAmount" maxLength="20">									          				 								
            				</div>
                			<div class="col-xs-4 pl5">
        			...
        			<div class="form-group" id="OA_AuthModeDiv"></div>
					...
					<label>Remarks</label>
					<div class="form-group">
						<input type="text" autocomplete='off'  class="form-control alphanumericlengthcontrol" id="OA_OtherRemarks" name="OA_otherRemarks" maxLength="16">
					</div>
					<div class="form-group has-error">
        			...
        			<div class="form-group">
            			<div class="custRadio_pass custRadio_medium">
                			<!--<div class="box">
                    			<div class="radio">
                        			<label>
                            			<input type="radio" name="payType" id="OwnAccPayNow" value="paynow" checked>
                            			<div class="row bg">
                			...
                			<!--<div class="box">
                    			<div class="radio">
                        			<label>
                        				<input type="radio" name="payType" id="OwnAccPayLater" value="paylater">
                        				<div class="row bg">
                            				<div class="col-xs-12 p0">
                			...
                			<div class="box">
                    			<div class="radio">
                        			<label>
                        				<input type="radio" name="payType" id="OwnAccRepeat" value="schpay">
                        				<div class="row bg">
                                			<div class="col-xs-12 p0">
            ...
            <div class="alert alert-info small" role="alert" id="ownAccShortNotesUIDiv" style="display:none;">
              <small>
                    <i class="fa fa-info-circle" aria-hidden="true"></i> <%-$.i18n.t('app.transferss.msg1note')%>
                      <div id="ownAccShortNotesDiv"> </div>
	                           <!--<ul>
                   ...
                   <div class="form-group">
		              <label class="check-label">
		                <input type="checkbox" name="transfer" id="termsand"> I agree to the <a href="javascript:void(0);" id="ownAccTandCPopup">Terms and Conditions</a>
        			...
        			<div class="row">
            			<div class="col-xs-6 pr5">
                			<button type="button" class="btn btn-default btn-block" id="OwnAcc_Init_BackBtn"><%-$.i18n.t('app.transferss.cancel')%></button>
            			</div>
            			<div class="col-xs-6 pl5">
                			<button id="OA_confirmButton" type="button" class="btn btn-primary btn-block"><%-$.i18n.t('app.transferss.next')%></button>
            			</div>
        			</div>
    			</form>
			</section>
