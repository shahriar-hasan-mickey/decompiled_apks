<%
    ...
    els.set("walletOneOffDispValue",tDataValue);
%>
                        	...
                        	<div class="ani-slideup animation-in">
                                ...
                                <div class="row">
                                        <div class="col-xs-6 pr5">
                                           <a href="javascript:void(0);" id="walletOneOffTransDownload" class="btn btn-primary cancel-btn btn-block"><span class="fa fa-download"></span> Download </a>
                                        </div>
                            ...
                            <div class="clearfix"></div>
                            	...
                            	<div class="row">
                                    <div class="col-xs-8 col-xs-offset-2 text-center">
                                    	<button type="button" id="walletOneTimePayAddAsBene" class="btn btn-primary cancel-btn btn-block">Add As Beneficiary</button>
                                	</div>
                                	<br/>
                            	</div>
					    		<div class="clearfix"></div>
