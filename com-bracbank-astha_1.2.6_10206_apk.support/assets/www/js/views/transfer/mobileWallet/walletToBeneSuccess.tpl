<%
	var els = new EncryptedLocalStorage('secret');
		...
		if(!isNull(dispFormDataWall)){
       var tDataKey = Object.keys(dispFormDataWall);
		var tDataValue = Object.values(dispFormDataWall);
    ...
    els.set("walletToBeneDispValue",tDataValue);
%>
                        	...
                        	<div class="ani-slideup animation-in">
                                ...
                                <div class="row">
                                        <div class="col-xs-6 pr5">
                                         	<a href="javascript:void(0);" id="walletToBeneTransDownload" class="btn btn-primary cancel-btn btn-block"><span class="fa fa-download"></span> Download </a>
                                        </div>
                            	...
                            	<div class="col-xs-8 col-xs-offset-2">
                                	<button type="button" id="walletToBeneMakeAnotherTransferBtn" class="btn btn-primary cancel-btn btn-block"><%-$.i18n.t('app.transferss.makeanothertransfer')%></button>
                        			<br/>
                        		</div>
                            	<div class="clearfix"></div>
                            	<br/>
