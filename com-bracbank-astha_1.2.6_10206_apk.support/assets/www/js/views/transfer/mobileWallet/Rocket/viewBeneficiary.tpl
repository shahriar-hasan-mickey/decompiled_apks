<div class="pagewrapper" id="appwrapper" >
	<header class="appheader">
  		...
  		<h4><%-$.i18n.t('app.transferss.payrocketheader')%><p class="small">(<%-$.i18n.t('app.transferss.bkashtext')%>)</p></h4>
			...
			<section class="content">
     			<div class="logWit small">
            		<div class="row">
                		...
                		<div class="col-xs-6 col-sm-6 pl5">
                    		<a href="javascript:void(0);" id="onetimepay" class="text-center">
        		...
        		<form>    
            		<div class="radio-list">
                		<div class="radio">
                    		<label>
                        		<input type="radio" class="choice" name="choice" value="withinbankbene1" id="bene1">
                		...
                		<div class="radio">
                    		<label>
                        		<input type="radio" class="choice" name="choice" value="withinbankbene2" id="bene2">
                        		<div class="radio-wrap">
                            		<div class="row">
                                		<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
