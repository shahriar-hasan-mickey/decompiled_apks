<div class="pagewrapper" id="appwrapper" >
	<header class="appheader">
  		<div class="headerLeft">
    		<a href="#/rockettobeneinitiatetransfer" class="bacArr">
  				<i class="fa fa-angle-left" aria-hidden="true"></i>
    		</a>
  		</div>
  		<h4><%-$.i18n.t('app.transferss.rocketverifytrans')%><p class="small">(<%-$.i18n.t('app.transferss.bkashtext')%>)</p></h4>
			...
			<section class="content">
    			<form>	
        			...
        			<div class="veriWrap">
            			...
            			<div class="media">
                			<div class="media-left media-middle">
                    			<img class="img-circle" src="images/common/user2.png" width="36" />
                			</div>
                			<div class="media-body media-middle">
                    			Tracy Scott
    				...
    				<div class="row">
            			...
            			<div class="col-xs-6 pl5">
                			<button type="button" class="btn btn-primary btn-block" data-toggle="modal" id="sendMoney"><%-$.i18n.t('button.transfer.sendmoney')%></button>
            			</div>
        			</div>
    			</form>
			</section>
            			...
            			<div class="modal-content">
                			...
                			<div class="modal-body">
                    			...
                    			<p class="text-center small">
                        			<a href="#" class="resend_button2" id="resend_btn"><%- $.i18n.t('app.registration.rensendotp') %></a>
                    			</p>
                			</div>
