...
<%
 	...
 	if(!isNull(dispFormDataWithi)){
      var tDataKey = Object.keys(dispFormDataWithi);
	    var tDataValue = Object.values(dispFormDataWithi);
    ...
    els.set("withinOneOffDispValue",tDataValue);
                ...
                <div class="dTable-middle">
                    <div class="container">
                            ...
                            <p class="text-center">
                                ...
                                <div class="row">
                                        <div class="col-xs-6 pr5">
                                             <a href="javascript:void(0);" id="withinOneOffTransDownload" class="btn btn-primary cancel-btn btn-block"><span class="fa fa-download"></span> Download </a>
                                        </div>
						...
						<div class="col-xs-8 col-xs-offset-2 text-center">
							   <button type="button" class="btn btn-primary cancel-btn btn-block" id="WithinBank_OneTimePay_AddasBeneficiary"><%-$.i18n.t('app.transferss.addasbene')%></button>
						  		 <br/>
						  </div>
							<div class="clearfix"></div>
                            <br>					   
                        <!--<div class="col-xs-12 text-center">
                         	<button type="button" class="btn btn-default" id="WithinBank_OneTimePay_EmailAdvice"><%-$.i18n.t('app.transferss.emailadvice')%></button>
                        </div>-->
					  </div>
                    </div>
                </div>
