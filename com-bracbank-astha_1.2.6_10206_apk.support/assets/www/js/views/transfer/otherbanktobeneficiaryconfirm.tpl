 <%
    ...
    if(!isNull(dispFormDataOthr)){
        var tDataKey = Object.keys(dispFormDataOthr);
	    var tDataValue = Object.values(dispFormDataOthr);
	...
	els.set("otherToBeneDispValue",tDataValue);
                    ...
                    <div class="dTable-middle">
                        <div class="container">
                            ...
                            <div class="ani-slideup animation-in">
                               ...
                               <!-- <p class="text-center"><%-$.i18n.t('app.transferss.msg3final')%></p>
                                <p class="text-center">
                                     <strong><%- els.get("transRefNo")%></strong>
                                </p>-->
                               ...
                               <div class="clearfix"></div>
                                <div class="row">
                                        <div class="col-xs-6 pr5">
                                          <a href="javascript:void(0);" id="otherToBeneTransDownload" class="btn btn-primary cancel-btn btn-block"><span class="fa fa-download"></span> Download </a>
                                        </div>
                        	...
                        	<div class="col-xs-8 col-xs-offset-2">
                         		   <button type="button" class="btn btn-primary cancel-btn btn-block" id="OB_ToBene_MakeAnotherTransfer"><%-$.i18n.t('app.transferss.makeanothertransfer')%></a>
                        			<br/>
                        	</div>
                        	<div class="clearfix"></div>
                            <br>  
                            <!-- / ani-slideup animation-in-->
                        </div>
                    </div>
                </div>
            </section>
