      			...
      			<form>
    				...
    				<div class="logWit small">
            			<div class="row">
                			<div class="col-xs-6 col-sm-6 pr5">
                    			<a href="#/binimoynewregistration" class="text-center">
        			...
        			<div class="panel paneldefault">
            			<div class="panel-body">
                			<label for="setup">Provide BINIMOY VID <span class="mandi">*</span></label>
                			<div class="input-group">
                    			<input type="text" class="form-control" id="binimoyExistingVID" aria-describedby="basic-addon2">
                				<span class="input-group-addon" id="basic-addon2">@binimoy</span>
                  			</div>
                  			<div class="form-group has-error">
								<p class="help-block error-message has-error" style="color:#a94442" id="binimoyExistingVIDError"></p>
							</div>
                  			<p>&nbsp;</p>
                  			<!--<div class="alert alert-info small" role="alert">
                    			<small><i class="fa fa-info-circle" aria-hidden="true"></i> Please click "Proceed" to provide your BINIMOY PIN in the next screen. Kindly remember your BINIMOY PIN for future reference.</small>
                   			</div>-->
                   			<div class="row">
                    			<div class="col-xs-6">
                        			<a href="javascript:void(0);" class="btn btn-default btn-block" id="binimoyExistingRegCancelBtn">Cancel</a>
                    			</div>
                    			<div class="col-xs-6">
                        			<a href="javascript:void(0);" class="btn btn-primary btn-block" id="binimoyExistingRegProceedBtn">Next</a>
                    			</div>
                  			</div>
            			</div>
        			</div>
