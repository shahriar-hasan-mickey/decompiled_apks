<%
	...
	var revovlingLoanStatement = loanMiniStmt.tranDetails;
...
<div class="pagewrapper" id="appwrapper" >
	...
	<header class="appheader">
		<div class="headerLeft">
			...
			<a href="#/revolveloan/<%- id%>" class="bacArr">
      			<i class="fa fa-angle-left" aria-hidden="true"></i>
			</a>
	      </div>
	      <div class="headerMiddle">			
			<h4 class="p10"><%-$.i18n.t('app.product.loan.revolveloanstmt')%></h4>
		</div>
		...
		<div class="contentwrap">
			<section class="content">
    			...
    			<ul class="list-group state-list txnSum">
    				<%if(revovlingLoanStatement.length > 0) { %>
	    				<% _.each(revovlingLoanStatement,function(data) { %>
