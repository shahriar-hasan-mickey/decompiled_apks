	...
	<header class="appheader">
		<div class="headerLeft">
	      ...
	      <div class="headerMiddle">			
			<h4 class="p10"><%-$.i18n.t('app.loan.loans')%></h4>
		</div>
                    ...
                    <li class="animation-in">
                        <a href="javascript:void(0);" id="termloan" >
                            <div class="c-cards-stack-item card card-default loan">
                                ...
                                <p class="name"><%-$.i18n.t('app.product.loan.termloan1')%></p>
                    ...
                    <li class="animation-in">
                        <a href="javascript:void(0);" id="depandloan" >
                            <div class="c-cards-stack-item card card-default loan">
                                ...
                                <p class="name"><%-$.i18n.t('app.product.loan.demandloan1')%></p>
                                <p class="numb small text-muted">182XXXXXXXXXX64</p>
                                <div class="amt">
                                    <p class="small m0 text-muted"><%-$.i18n.t('app.product.loan.currentoutbal')%></p>
                    ...
                    <li class="animation-in">
                        <a href="javascript:void(0);" id="revokeloan" >
                            <div class="c-cards-stack-item card card-default loan">
                                ...
                                <p class="name"><%-$.i18n.t('app.product.loan.revolveloan1')%></p>
                                <p class="numb small text-muted">182XXXXXXXXXX64</p>
                                <div class="amt">
                                    <p class="small m0 text-muted"><%-$.i18n.t('app.product.loan.currentoutbal')%></p>
