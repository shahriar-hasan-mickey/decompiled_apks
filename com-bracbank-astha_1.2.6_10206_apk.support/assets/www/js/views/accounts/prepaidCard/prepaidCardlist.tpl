        			...
        			<div class="dashTab accDet cardListAni">
						...
						<%} else if(prepaidListArray.length > 0){%>	
							...
							<li class="animation-in">
								<a href="javascript:void(0)" class="prepaidcardlist" id="<%- index%>" productCode="<%- data.productCode %>" currency="<%- data.currencyCode%>" availBalance="<%- data.availableBalance%>">                            
									<div class="cc_summary_design pp<%- data.productCode %>">
									  <div class="cc_container">
										...
										<div class="row cc_balance">
											<div class="col-xs-12">
												<p class="small lbl"><%-$.i18n.t('app.prepaidcard.creditavail')%></p>
												<p class="amt">
