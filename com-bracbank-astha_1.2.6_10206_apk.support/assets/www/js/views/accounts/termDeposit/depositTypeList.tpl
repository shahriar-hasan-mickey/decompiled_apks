    			...
    			<form>
					...
					<div class="row">
			          <div class="col-xs-8 col-xs-offset-2">
			            <button type="button" class="btn btn-default btn-block" id="applydepositpage"><%-$.i18n.t('app.product.termdeposits.aplydeposit')%></button>
			          </div>
			        </div>
        			...
        			<div class="dashTab accDet cardListAni">
						<ul class="nav nav-tabs text-center" role="tablist">
						  <li id="FDR" role="presentation" class="depositTypeItems"><a href="javascript:void(0)">FDR</a></li>
						  <li id="DPS" role="presentation" class="depositTypeItems" ><a href="javascript:void(0)">DPS</a></li>
						</ul>
