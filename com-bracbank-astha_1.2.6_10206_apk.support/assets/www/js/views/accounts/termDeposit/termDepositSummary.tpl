<%
	...
	var depositAccountListDTO = els.get("depositAccountList");
	var depositListArray = "";
	if(!isNull(depositAccountListDTO)) {
		depositListArray = depositAccountListDTO.filter(function(array) {
            	...
            	<div class="userInfo">
          		...
          		<div class="dashTab">
					<ul class="nav nav-tabs" role="tablist">
						...
						<li role="presentation" class="active"><a href="javascript:void(0);" id="termdeposit_tab"><%-$.i18n.t('app.wealth.termdeposit')%></a></li>
							...
							<% } else if(depositListArray.length > 0){%>
								...
								<ul class="stack-container">
									<% _.each(depositListArray,function(data, index){%>
										...
										<li id="carddetails" class="c-cards-stack-item card card-default deposit" tdId="<%- data.id%>" data-url="#/dpssummary/<%-index%>" cardHolderName="<%- productName%>" productCode="<%- data.productcode%>" category="<%- data.depositType%>" currency="<%- data.currencyCode%>" availBalance="<%- data.principalBalance%>" branchCode="<%- data.branchCode%>">	
											...
											<div class="amt text-center">
											   <% if(data.depositType == "RD") { %>
									             ...
									             <% } else if(els.get("dashbaordShowHideFlag") == "Hide") { %>
													...
													<% } else { %>
														<span class="num neg"><%- data.maskedPrincipalBalance%></span> <span class="small cur dCur text-muted"><%- data.currencyCode%></span>
													<% } %>		
									             <% }%> 
					...
					<ul class="list-unstyled">
    					...
    					<li class="list-group-item">
        					<div class="media">
            					...
            					<div class="media-body">
                					<p><%-$.i18n.t('app.wealth.creditcarddue1')%></p>
    					...
    					<li class="list-group-item">
        					<div class="media">
            					...
            					<div class="media-body">
                					<p><%-$.i18n.t('app.wealth.standinginstruction1')%></p>
    					...
    					<li class="list-group-item">
        					<div class="media">
            					...
            					<div class="media-body">
                					<p><%-$.i18n.t('app.wealth.loaninstalment1')%></p>
