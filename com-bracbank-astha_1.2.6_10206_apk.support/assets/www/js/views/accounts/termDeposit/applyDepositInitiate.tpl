...
%>	
	...
	<header class="appheader">
		<div class="headerLeft">
			...
			<a href="javascript:void(0);" id="backButn" class="bacArr">
      			<i class="fa fa-angle-left" aria-hidden="true"></i>
			</a>
	      </div>
	      <div class="headerMiddle">			
			<h4 class="p10"><%-$.i18n.t('app.product.termdeposits.fdaccount')%></h4>
		</div>
	...
	<form>
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<select class="form-control" id="FDRSelectAcc">
					...
					<div class="form-group">
						 <label for="acc"><%-$.i18n.t('app.product.termdeposits.fdprodtype')%></label>
						 <select class="form-control" id="FDRProductTypeSelect">
						 </select>
						 <div class="form-group has-error">
					...
					<div class="form-group">
						<label for="amt"><%-$.i18n.t('app.product.termdeposits.amount')%></label>
						<div class="row">
							<div class="col-xs-8 pr5">
								<input type="tel" autocomplete='off' class="form-control numericlengthcontrol" data-type="currency" pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" onkeyup="withoutstartZero(event,'amt')" maxlength="20" id="amt">
								<div class="form-group has-error">
					...
					<div class="form-group">
						 ...
						 <select class="form-control" id='FDRTenorSelect'>
						 </select>
					   ...
					   <div class="form-group" >
						 ...
						 <input type="text" class="form-control" value="" readonly="" id="fdrmaturitAmt">

					   </div>
					   <div class="form-group">
							<label><%-$.i18n.t('app.product.termdeposits.optrenewal')%></label>
							<p class = "row"></p>
							<div class="btn-group" data-toggle="buttons">
							  <label class="btn btn-primary active">
								<input type="radio" name="options" id="Debit" value="yes" checked=""> <%-$.i18n.t('app.product.termdeposits.yes')%>
							  </label>
							  <label class="btn btn-primary" id="LostBtn" >
								<input type="radio" name="options" id="Lost" value="no"> <%-$.i18n.t('app.product.termdeposits.no')%>
							  </label>
							</div>
						 </div>

						  <div class="form-group" id="renewalType" >
						 <label for="acc"><%-$.i18n.t('app.product.termdeposits.renewaltype')%></label>
						 <select class="form-control" id="renewalTypeOption">
						  <option value="sltRenewalType"><%-$.i18n.t('app.product.termdeposits.seltrenewtype')%></option>
						  <option value="M"><%-$.i18n.t('app.product.termdeposits.renewprinciint')%></option>
						  <option value="P"><%-$.i18n.t('app.product.termdeposits.renewprinciintlink')%></option>
						 </select>
						 	<div class="form-group has-error">
									<p class="help-block error-message has-error" style="color:#a94442" id="renewalError"></p>
	 							</div>
						 </div>
						
					   <div class="form-group" id="credAccount">
						 <label><%-$.i18n.t('app.product.termdeposits.creditacc')%></label>
						 <select class="form-control" disabled="" id="credAccSelt" tabindex="-1">
						  <option value=""  selected="selected"><%-$.i18n.t('app.product.termdeposits.selectacc')%></option>
                 			<%_.each(casaDTO,function(data,index){%>
					...
					<div class="form-group" id="nominee_Relation">		  
						<ul class="list-unstyled" id="nominee_Details">
            ...
            <div class="row">
                <div class="col-xs-6"><button type="button" class="btn btn-default btn-block" id="applydepositcancel"><%-$.i18n.t('app.product.termdeposits.cancel')%></button></div>
                <div class="col-xs-6"><button type="button" class="btn btn-primary btn-block" id="applydepositverify"><%-$.i18n.t('app.product.termdeposits.submit')%></button></div>
            </div>
        ...
        <form method="post" action="#">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="fd_myModalLabel"></h4>
                </div>
