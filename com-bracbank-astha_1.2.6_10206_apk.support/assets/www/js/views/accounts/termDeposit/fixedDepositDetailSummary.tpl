	...
	<header class="appheader">
		<div class="headerLeft">
	      ...
	      <div class="headerMiddle">			
			<h4 class="p10"><%-$.i18n.t('app.product.termdeposits.title')%></h4>
		</div>
			...
			<section class="content">
    			<div class="dashTab accDet">
        			<div class="vc-card">
            			...
            			<% if(myaccountslist.length > 0){%>
									<% _.each(myaccountslist,function(data){%>
                			<li>
                        		<div class="card card-default acc deposit">
                            		...
                            		<p class="numb small text-muted"><%- data.accountNumber%> | <%- data.productName%></p>
                            		<div class="amt">
                            			<p class="small m0 text-muted"><%-$.i18n.t('app.product.termdeposits.principalamt')%></p>                                		
    			...
    			<div class="state-wrap">
        			<ul class="list-unstyled list-nobrd">
        				<li class="list-group-item">
                			...
                			<div class="amt">
                				<span class="num">12,000.<span class="deci">00</span></span>
                			</div>
        				</li>
        				<li class="list-group-item">
                			<p class="text-muted small"><%-$.i18n.t('app.product.termdeposits.maturedate')%></p>
                			<div class="dater">
                				<span class="dd d_cd">18</span> <span class="mm d_cm">Nov</span> <span class="yy d_cy">2018</span>
                			</div>
        				</li>
        				<li class="list-group-item">
        				...
        				<li class="list-group-item">
                			<p class="small text-muted"><%-$.i18n.t('app.product.termdeposits.proddesc')%></p>
                			<p>Lorem</p>
        				</li>
        				<li class="list-group-item">
