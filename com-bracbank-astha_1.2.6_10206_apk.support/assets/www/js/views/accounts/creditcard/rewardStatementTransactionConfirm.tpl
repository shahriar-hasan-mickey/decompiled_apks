                            ...
                            <div class="ani-slideup animation-in">
                                ...
                                <div class="row">
									<div class="col-xs-6 pr5">
										<button type="button" class="btn btn-primary cancel-btn btn-block" id="rewardStatementRedeem_MakeAnother"><%-$.i18n.t('app.transferss.makeanothertransfer')%></a>
									</div>
									<div class="col-xs-6 pl5">
										 <button type="button" class="btn btn-primary cancel-btn btn-block" id="gotoRewardPointsHomeBtn">Home</button>
									</div>
                                </div>
                                 <!--<div class="row">
