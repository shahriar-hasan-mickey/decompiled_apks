	            			...
	            			<ul class="list-group state-list txnSum">
	        				 <%_.each(rewardpointsInquiryListDTO,function(data,index){%>
	        				 	...
	        				 	<li class="list-group-item">
	                      			<a href="javascript:void(0);" class="rewardStatementList" index="<%- index%>" postingDate="<%- data.postingDate%>" rewardFlag="<%- data.rewardFlag%>" transactionSeqNo="<%- data.transactionSeqNo%>" transactionCode="<%- data.transactionCode%>" requiredRewardPoints="<%- data.requiredRewardPoints%>" schemeCode="<%- data.schemeCode%>" transactionCurrencyCode="<%- data.transactionCurrencyCode%>" billingCurrencyCode="<%- data.billingCurrencyCode%>" billingAmount="<%- data.billingAmount%>" mcc="<%- data.mcc%>" rewardPointRedeemIndicator="<%- data.rewardPointRedeemIndicator%>" transactionDate="<%- data.transactionDate%>" transactionDescription="<%- data.transactionDescription%>" transactionAmount="<%- data.transactionAmount%>" cardNumber="<%- data.cardNumber%>">
