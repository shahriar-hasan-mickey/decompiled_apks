          ...
          <li>
            <a href="#/accounts">
              <div class="card card-default acc">
                ...
                <p class="name"><%- els.get("profileName")%></p>
                <p class="numb small text-muted"><%- data.accountNumber%> | Salary Account</p>
                <div class="amt">
                  <p class="small m0 text-muted"><%-$.i18n.t('app.creditcardstmt.currentbalance')%></p>
                  <span class="num"><%- data.availableCreditLimit %>
                   
                  </span>
                  <span class="small cur dCur text-muted"><%- checkAmount($.formatNumber(data.availableCreditLimit, {format:"#,###.00", locale:"us"})) %></span>
                </div>
