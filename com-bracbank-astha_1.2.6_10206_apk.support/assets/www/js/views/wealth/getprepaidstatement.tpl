...
<a href="#/investmentstatement/<%-acccid%>" class="pull-left btn btn-default btn-sm back-btn"><span class="glyphicon glyphicon-chevron-left"></span></a>
<ol class="breadcrumb cust_breadcrumb pull-left">
	<!--Breadcrumb Starts Here-->
	<li><a href="#/wealth" ><%-$.i18n.t('app.product.general.title')%></a></li>
	<li><a href="#/investmentstatement/<%-acccid%>"><%-$.i18n.t('app.product.general.statement')%></a></li>
...
<script type="text/javascript">
	...
	function go_to_page(page_num){
		...
		Backbone.history.navigate("#/showotherpagesprepaidcard/"+pagen);
	}
...
function PDFDownload(){
		...
		var pdfDownloadUrl = "device_id="+device_id+"&appchecksum="+appCheckSum+"&lang_id="+lang_id+"&accountNumber="+accountNumber+"&download=PDF&cardoract=CARD";
