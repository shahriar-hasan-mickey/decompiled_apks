...
<%}%>
                        ...
                        <input type="button" class="btn btn-success btn-block" id="kycaskyes" value="<%-$.i18n.t('app.mpin.yes')%>" />
                        <input type="button" id="kycaskno" class="btn btn-primary btn-block" value="<%-$.i18n.t('app.mpin.no')%>"/>
