<%
	...
	console.log("acccid",acccid);
%>

<a href="#/invstmentstatement/<%-acccid%>" class="pull-left btn btn-default btn-sm back-btn"><span class="glyphicon glyphicon-chevron-left"></span></a>
<ol class="breadcrumb cust_breadcrumb pull-left">
	<!--Breadcrumb Starts Here-->
	<li><a href="#/wealth" ><%-$.i18n.t('app.product.general.title')%></a></li>
	<li><a href="#/invstmentstatement/<%-acccid%>"><%-$.i18n.t('app.product.general.statement')%></a></li>
...
<script type="text/javascript">
	...
	function go_to_page(page_num){
		...
		Backbone.history.navigate("#/showotherpagesdeposit/"+pagen);
	}
...
function PDFDownload(){
	    ...
	    var access_token = els.get('access_token');
				...
				var cdbflag = els.get("cdbflag");
				var fromamtt=els.get("frmamtdep");
				var toamtt=els.get("toamtdep");
				var emailRequired ='';
			     			if(fromamtt!=""){
			        			fromamtt = fromamtt;
			        		}else{
		...
		var pdfDownloadUrl = "accountID="+acctid+"&fromDate="+fromdate+"&toDate="+todate+"&fromAmount="+fromamtt+"&toAmount="+toamtt+"&lastnTxn="+lastnTxn+"&emailRequired="+emailRequired+"&appchecksum="+appCheckSum+"&access_token="+access_token+"&download=PDF&type=DEPOSIT";
...
function XLSdownload()
{
	...
	var pdfDownloadUrl = "accountID="+acctid+"&fromDate="+fromdate+"&toDate="+todate+"&fromAmount="+fromamtt+"&toAmount="+toamtt+"&lastnTxn="+lastnTxn+"&emailRequired="+emailRequired+"&appchecksum="+appCheckSum+"&access_token="+access_token+"&download=XLS&type=DEPOSIT";
