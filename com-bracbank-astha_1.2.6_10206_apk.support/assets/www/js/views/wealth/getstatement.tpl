...
<ol class="breadcrumb cust_breadcrumb pull-left">
	...
	<li><a href="#/statement/<%-acccid%>"><%-$.i18n.t('app.product.general.statement')%></a></li>
...
function XLSdownload()
{
	...
	var pdfDownloadUrl = "accountID="+acctid+"&fromDate="+fromdate+"&toDate="+todate+"&fromAmount="+fromamtt+"&toAmount="+toamtt+"&lastnTxn="+lastnTxn+"&emailRequired="+emailRequired+"&appchecksum="+appCheckSum+"&access_token="+access_token+"&download=XLS&type=CASA";
