...
%>
  ...
  <div class="headerLeft">
    <a href="javascript:void(0);" id="creditcardbackdetails" class="bacArr">
            ...
            <div class="vc-card">
                <ul class="list-unstyled">
                    <li class="animation-in">
                        <a href="javascript:void(0);" id="creditcardbackdetailsnav">
                    ...
                    <li class="animation-in">
                        <a href="javascript:void(0);" id="creditcardbackdetailsnav">
                            <div class="card card-default acc card-CC card-CC-plat master-CC">
                    ...
                    <li class="animation-in">
                        <a href="javascript:void(0);" id="creditcardbackdetailsnav">
                            <div class="card card-default acc card-CC card-CC-default master-CC">
                                <p class="m0">Titanium Card
                                    <span class="logo-xs pull-right"></span>
                                </p>
                                <span class="menu_icon chip pull-left"></span>
                                <div class="clearfix"></div>
                                <h4 class="ac-num text-muted text-center">
                                    <span class="cc-no">5462</span>
                                    <span class="cc-no">XXXX</span>
                                    <span class="cc-no">XXXX</span>
                                    <span class="cc-no">7841</span>
                                </h4>
                                <div class="amt">
                                    <p class="small m0 text-muted">Outstanding Balance</p>
                                    <span class="num">5,85,820.
                                        <span class="deci">56</span>
                                    </span>
                                    <span class="small cur dCur text-muted">BDT</span>
                                </div>
                    ...
                    <li class="animation-in">
                        <a href="javascript:void(0);" id="creditcardbackdetailsnav">
                            <div class="card card-default acc card-CC card-CC-gold visa-CC">
                                ...
                                <div class="clearfix"></div>
                                <h4 class="ac-num text-muted text-center">
                                    <span class="cc-no">8546</span>
                                    <span class="cc-no">XXXX</span>
                                    <span class="cc-no">XXXX</span>
                                    <span class="cc-no">5412</span>
                                </h4>
                                <div class="amt">
                                    <p class="small m0 text-muted">Outstanding Balance</p>
                                    <span class="num">8,840.
                                        <span class="deci">20</span>
                                    </span>
                                    <span class="small cur dCur text-muted">BDT</span>
                                </div>
                                <div class="has_link"><i class="fa fa-angle-right" aria-hidden="true"></i></div>
