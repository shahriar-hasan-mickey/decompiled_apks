...
var accidd = els.get("acccid");

%>
    <!--Mobile Content starts here -->
	<a href="#/statement/<%-accidd%>" class="pull-left btn btn-default btn-sm back-btn"><span class="glyphicon glyphicon-chevron-left"></span></a>
    <!-- Breadcrumb Starts Here -->
    <ol class="breadcrumb cust_breadcrumb pull-left">
             <li><a href="#/wealth"><%-$.i18n.t('app.product.general.title')%></a></li>
             <li>
             		
             			<a href="#/statement/<%-accidd%>"><%-$.i18n.t('app.product.general.accountstmt')%></a>
				                    	...
				                    	<tbody>
				                    				...
				                    				<tr>
							               		       <td><%-$.i18n.t('app.creditcard.cclimit.refno')%></td>
							                    	   		<td><%-ministatement[id].referenceTransactionNo%></td>
							                  ...
							                  <!--<tr>
				                    			...
				                    			<tr>
						                      		<td><%-$.i18n.t('app.creditcard.convertinstall.description')%></td>
						                      			<td><%-ministatement[id].description%></td>
						                      </tr>
						                       ...
						                       <tr>
						                      		<td><%-$.i18n.t('app.creditcard.unbilled.transactiondate')%></td>
						                      			<td class="date_ltr"><%-ministatement[id].txnDate%></td>
						                      </tr>
						                     ...
						                     <!-- <tr>
						                      ...
						                      <tr>
						                		     <td><%-$.i18n.t('app.product.accounts.currentbalance')%></td>
						                      			<td class="amt"><span>
						                      			<%-ministatement[id].runningTotal%>
						                      			</span></td>
						                      </tr>
						 					 	...
						 					 	<a href="#/statement/<%-accidd%>" class="btn btn-success btn-block"><%-$.i18n.t('app.product.transactiondetails.back')%></a>
