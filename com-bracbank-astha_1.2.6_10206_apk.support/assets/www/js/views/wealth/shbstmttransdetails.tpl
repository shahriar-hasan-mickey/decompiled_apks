...
%>
    ...
    <ol class="breadcrumb cust_breadcrumb pull-left">
             ...
             <li><a href="#/statement/<%-accidd%>"><%-$.i18n.t('app.product.general.statement')%></a></li>
				                    	...
				                    	<tbody>
				                    				<tr>
							               		       <td><%-$.i18n.t('app.creditcard.cclimit.refno')%></td>
							                    	   		<td><%-transdetailspages.referenceTransactionNo%></td>
							                  ...
							                  <!--<tr>
				                    			...
				                    			<tr>
						                      		<td><%-$.i18n.t('app.creditcard.convertinstall.description')%></td>
						                      			<td><%-transdetailspages.description%></td>
						                      </tr>
						                       ...
						                       <tr>
						                      		<td><%-$.i18n.t('app.creditcard.unbilled.transactiondate')%></td>
						                      			<td class="date_ltr"><%-transdetailspages.txnDate%></td>
						                      </tr>
						                     ...
						                     <!-- <tr>
						                      		<td><%-$.i18n.t('app.transfer.transferhistory.valuedate')%></td>
						                      			<td><%-transdetailspages.valueDate%></td>
						                      </tr>-->
						                      ...
						                      <tr>
						                		     <td><%-$.i18n.t('app.product.accounts.currentbalance')%></td>
						                      			<td class="amt"><span>
						                      			<%-transdetailspages.runningTotal%>
						                      			</span></td>
						                      </tr>
