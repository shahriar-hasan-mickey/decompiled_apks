              ...
              <img src="images/common/1234.png" class="profPic img-circle">
				  ...
				  <!-- Nav tabs -->
				   <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation"class="active"><a href="javascript:void(0);" id="prepaidcreditcard"><%-$.i18n.t('app.wealth.prepaidcard')%></a></li>
					...
					<div role="tabpanel" class="tab-pane active" id="Accounts">
                        <div class="c-cards-stack">       
							<ul class="stack-container">
								<li class="c-cards-stack-item card card-default acc card-CC card-CC-gold visa-CC" data-url="#/showpaginationprepaidcard">									
								...
								<li class="c-cards-stack-item card card-default acc card-CC card-CC-plat master-CC status-blocked" data-url="#/showpaginationprepaidcard">
								  <p class="m0">Platinum Card <span class="logo-xs pull-right"></span></p>
									...
									<div class="amt">
									  <p class="small m0 text-muted"><%-$.i18n.t('app.creditcard.creditavailable')%></p>
									  <span class="num">65,452.<span class="deci">56</span></span>
									  <span class="small cur dCur text-muted">BDT</span>
									</div>
    ...
    <div class="promo">
        <ul class="list-unstyled">
            <li class="list-group-item row">
                <div class="clearfix">
                    <div class="col-xs-5">
<img src="images/common/homeLoan.jpg" class="img-responsive" />                    </div>
