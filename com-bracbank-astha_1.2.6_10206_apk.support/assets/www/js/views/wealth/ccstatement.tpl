...
%>
  ...
  <div class="headerLeft">
    <a href="javascript:void(0);" id="creditcardstmt" class="bacArr">
      <i class="fa fa-angle-left" aria-hidden="true"></i>
    </a>
  </div>
  <h4><%-$.i18n.t('app.ccstatement.creditcard')%></h4>
            ...
            <div class="vc-card">
                <ul class="list-unstyled">
                    <li>
                         <a href="javascript:void(0);" id="creditcarddeatilstamt">
        ...
        <!-- Nav tabs -->
        <div class="links">
            <a href="javascript:void(0);" id="getsupplementarycard"><%-$.i18n.t('app.ccstatement.supplementarycards')%></a>
        ...
        <div class="state-wrap">
            ...
            <h3 class="dropdown tab-head">
                <button class="billedStm" id="unbill" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <%-$.i18n.t('app.ccstatement.unbilledstatement')%>
                    <span class="caret"></span>
                </button>
                <ul class="dropdown-menu" aria-labelledby="unbill">
                    <li>
                        <a href="creditCard.html"><%-$.i18n.t('app.ccstatement.unbilledstatement')%></a>
                    </li>
                    <li>
                        <a href="creditCard_billed.html"><%-$.i18n.t('app.ccstatement.billedstatement')%></a>
                    </li>
                    <li>
                        <a href="#"><%-$.i18n.t('app.ccstatement.paymentsincelaststatement')%></a>
                    </li>
                    <li>
                        <a href="lastSix_monthStatement.html"><%-$.i18n.t('app.ccstatement.laststatement')%></a>
                    </li>
                </ul>
            ...
            <ul class="list-group state-list txnSum">
                <li class="list-group-item">
                    ...
                    <p><%-$.i18n.t('app.ccstatement.wo1')%></p>
        ...
        <form method="post" action="#">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-block" data-dismiss="modal" data-toggle="modal" data-target="#shareme">Ok</button>
                </div>
            </div>
        </form>
    </div>
      ...
      <form method="post" action="info.html">
          <div class="modal-content">
              <div class="modal-header">
                  ...
                  <h4 class="modal-title" id="myModalLabel"><%-$.i18n.t('app.ccstatement.wo11')%></h4>
              </div>
