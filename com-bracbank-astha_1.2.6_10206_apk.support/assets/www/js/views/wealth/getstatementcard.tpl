...
<a href="#/ccstatement2/<%-cccard%>" class="pull-left btn btn-default btn-sm back-btn"><span class="glyphicon glyphicon-chevron-left"></span></a>
<ol class="breadcrumb cust_breadcrumb pull-left">
	<!--Breadcrumb Starts Here-->
	<li><a href="#/wealth" ><%-$.i18n.t('app.product.general.title')%></a></li>
	<li><a href="#/ccstatement2/<%-cccard%>"><%-$.i18n.t('app.product.general.statement')%></a></li>
...
<script type="text/javascript">
	...
	function go_to_page(page_num){
		...
		Backbone.history.navigate("#/showotherpagescard/"+pagen);
	}
...
function PDFDownload(){
	    ...
	    appurl= appContextPath+'creditcard/ministatement/download.pdf';
	    var access_token = els.get('access_token');
	            	...
	            	var acctid = myaccounts[cccard].id;
		...
		var pdfDownloadUrl = "accountID="+acctid+"&fromDate="+fromdate+"&toDate="+todate+"&fromAmount="+fromamtt+"&toAmount="+toamtt+"&lastnTxn="+lastnTxn+"&emailRequired="+emailRequired+"&appchecksum="+appCheckSum+"&access_token="+access_token+"&type="+type+"&download=PDF&flag=CC";
...
function XLSdownload()
{
	...
	var pdfDownloadUrl = "accountID="+acctid+"&fromDate="+fromdate+"&toDate="+todate+"&fromAmount="+fromamtt+"&toAmount="+toamtt+"&lastnTxn="+lastnTxn+"&emailRequired="+emailRequired+"&appchecksum="+appCheckSum+"&access_token="+access_token+"&type="+type+"&download=XLS&flag=CC";
