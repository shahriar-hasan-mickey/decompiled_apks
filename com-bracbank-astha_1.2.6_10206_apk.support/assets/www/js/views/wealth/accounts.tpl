...
%>
  ...
  <h4>Savings Account</h4>
    ...
    <div class="dashTab accDet">
      ...
      <div class="vc-card">
        <ul class="list-unstyled">
          <li>
            <a href="javascript:void(0);" id="accstatview">
    ...
    <!-- Nav tabs -->
    <div class="links">
      <a href="javascript:void(0);" id="getaccstmt"><%-$.i18n.t('app.creditcardstmt.detailedstatement')%></a>
      <a href="" data-toggle="modal" data-target="#expenseSum"><%-$.i18n.t('app.creditcardstmt.expensesummary')%></a>
      <a href="javascript:void(0);" id="gethistory"><%-$.i18n.t('app.creditcardstmt.chequehistory')%></a>
    </div>
    <!-- / account details-->
    <!-- statement-->
      ...
      <h3 class="tab-head"><%-$.i18n.t('app.creditcardstmt.ministatement')%>
        <div class="dropdown pull-right">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
            ...
            <li><a href="javascript:void(0);" id="sharehistory"><%-$.i18n.t('app.creditcardstmt.sharehistory')%><</a></li>
...
<div class="modal fade modernPOP shareme" id="shareme" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  ...
  <small><%-$.i18n.t('app.creditcardstmt.mail')%></small> <%- email%></div>                  </div>
