...
<nav>
        ...
        <li><a href="javascript:void(0);" id="transfer"><span class="ico transfer"></span><%-$.i18n.t('app.wealth.transfers')%></a></li>
        ...
        <li><a href="javascript:void(0);" id="slide_out_services"><span class="ico service"></span><%-$.i18n.t('app.wealth.services')%></a></li>
              ...
              <div class="media">
				  ...
				  <!-- Nav tabs -->
				   <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation"class="active"><a href="javascript:void(0);" id="creditcard"><%-$.i18n.t('app.wealth.creditcard')%></a></li>
                        <li role="presentation"><a href="javascript:void(0);" id="prepaidcreditcard"><%-$.i18n.t('app.wealth.prepaidcard')%></a></li>
                        <li role="presentation"><a href="javascript:void(0);" id="loan"><%-$.i18n.t('app.wealth.loans')%></a></li>                      </ul>
					...
					<div role="tabpanel" class="tab-pane active" id="Accounts">
						<div class="c-cards-stack">       
							<ul class="stack-container">
								<li class="c-cards-stack-item card card-default acc card-CC card-CC-gold visa-CC" data-url="#/ccstatement">									
								 <a href="javascript:void(0);" id="creditcarddetails">
								  <p class="m0">Gold Card <span class="logo-xs pull-right"></span></p>
									...
									<div class="amt">
									  <p class="small m0 text-muted"><%-$.i18n.t('app.creditcard.creditavailable')%></p>
									  <span class="num">5,52,541.<span class="deci">56</span></span>
									  <span class="small cur dCur text-muted">BDT</span>
									</div>
									 </a>
								</li>
					
								<li class="c-cards-stack-item card card-default acc card-CC card-CC-plat master-CC" data-url="#/ccstatement">
								  <p class="m0">Platinum Card <span class="logo-xs pull-right"></span></p>
									<span class="menu_icon chip pull-left"></span>
									<div class="clearfix"></div>
									<h4 class="ac-num text-muted text-center">
									  <span class="cc-no">4851</span>
									  <span class="cc-no">XXXX</span>
									  <span class="cc-no">XXXX</span>
									  <span class="cc-no">6235</span>
									</h4>
									<div class="amt">
									  <p class="small m0 text-muted"><%-$.i18n.t('app.creditcard.creditavailable')%></p>
									  <span class="num">2,98,652.<span class="deci">56</span></span>
									  <span class="small cur dCur text-muted">BDT</span>
									</div>
								</li>
					
								<li class="c-cards-stack-item card card-default acc card-CC card-CC-default master-CC" data-url="#/ccstatement">									
								  <p class="m0">Titanium Card <span class="logo-xs pull-right"></span></p>
									<span class="menu_icon chip pull-left"></span>
									<div class="clearfix"></div>
									<h4 class="ac-num text-muted text-center">
									  ...
									  <span class="cc-no">XXXX</span>
									  <span class="cc-no">XXXX</span>
									  <span class="cc-no">2315</span>
									</h4>
									<div class="amt">
									  <p class="small m0 text-muted"><%-$.i18n.t('app.creditcard.creditavailable')%></p>
									  <span class="num">1,98,210.<span class="deci">56</span></span>
									  <span class="small cur dCur text-muted">BDT</span>
									</div>
								</li>
					
								<li class="c-cards-stack-item card card-default acc card-CC card-CC-gold visa-CC status-blocked" data-url="#/ccstatement">									
								  <p class="m0">Gold Card <span class="logo-xs pull-right"></span></p>
								  <span class="menu_icon chip pull-left"></span>
								  <div class="clearfix"></div>
								  <h4 class="ac-num text-muted text-center">
