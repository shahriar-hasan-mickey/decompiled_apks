...
<div class="form-group required">
		<div class="dropselect"  data-title="<%-$.i18n.t('app.tedallalrewards.selectatmcard')%>" data-setid="acid" >
							    	...
							    	<p>
							        	<%if(typeof(data.atmCardNumber)!="undefined"){%> 
							        	        <input type="radio" value="<%-data.atmCardNumber%>~<%-data.primaryAccount%>~<%-data.cardTypeDescription%>"  name="accno" id="accno"/>
												 <span id="account" value="<%-data.atmCardNumber%>"><%-data.atmCardNumber%></span><br>
	    ...
	    <div id="errorAct" style="display:none">
	    	<p class="help-block error-message">
	        	<font color="#A94442"><%-$.i18n.t('app.tedallalrewards.plzselectatmcard')%></font>
			</p>
		</div><br>	
		...
		<label for="reason"><%-$.i18n.t('app.requests.chequebookreq.repreason')%></label>
					<div class="form-group required">
						...
						<select name="repreason" id="repreason" class="form-control">
				        	<option value="00" selected="selected" ><%-$.i18n.t('app.requests.blkdebitcard.plzselectreson')%></option>
           ...
           <label for="replace"><%-$.i18n.t('app.requests.blkdebitcard.reissueatm')%></label>
					<div class="form-group required">
						...
						<select name="rplacecard" id="rplacecard" class="form-control">
				        	<option value="00" selected="selected" ><%-$.i18n.t('app.requests.blkdebitcard.plzselectrplc')%></option>
        ...
        <input type="button" class="btn btn-success btn-block" id="stopatmcardrequest" name="stopatmcardrequest" value="<%-$.i18n.t('app.requests.blkdebitcard.submit')%>" />
