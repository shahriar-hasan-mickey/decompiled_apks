                  ...
                  <div class="steps done"><span></span><div>3<p><%-$.i18n.t('app.requests.homefinance.confirm')%></p></div></div>
                    ...
                    <!--One Time Billpay Starts Here-->
                     ...
                     <div class="alert alert-success text-center">
                      <strong><%-$.i18n.t('app.requests.additionalAccount.dearCustomer')%></strong>
						<% if(debitCardUsed == "YES") { %>
							<% if(deliveryType == "branch") { %>                                     
                                      <%-$.i18n.t('app.requests.additionalAccount.accountOpeningSuccessBranch')%>
                                      
                                      <p><a class="btn btn-default" id="addopenlocatusurl" name="addopenlocatusurl"><%-$.i18n.t('app.requests.additionalAccount.locateBranch')%></a></p>
                                  
							<% } else { %>
								<%-$.i18n.t('app.requests.additionalAccount.accountOpeningSuccessPost')%>
							<% } %>
						<% } else { %>
							<%-$.i18n.t('app.requests.additionalAccount.accountOpeningSuccess')%>
						<% } %>
                                </div>
                  ...
                  <form role="form">
                    <table class="table table-bordered table-striped">
                      ...
                      <tr>
                          ...
                          <td><%- secActOpeningDTO.accountNumber %></td>
                      </tr>                      <tr>
                    ...
                    <a href="#/wealth" class="btn btn-primary btn-block"><%-$.i18n.t('app.creditcard.activatecc.home')%></a>
