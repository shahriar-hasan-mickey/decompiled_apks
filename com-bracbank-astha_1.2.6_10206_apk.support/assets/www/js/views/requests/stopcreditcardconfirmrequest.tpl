    ...
    <!-- Breadcrumb Starts Here -->
      ...
      <br/>
        ...
        <form role="form">
                  ...
                  <input type="button" id="managecreditcardrequestconfirm" name="managecreditcardrequestconfirm" class="btn btn-success btn-block"  value="<%-$.i18n.t('app.requests.blkdebitcard.confirm')%>"/>
