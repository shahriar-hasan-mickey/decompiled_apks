                            ...
                            <div class="ani-slideup animation-in">
                                ...
                                <div class="text-center">
                                	<%if(els.get("selectedBillerListName") != "DPDC") {%>
	                                    <p>You have successfully added
	                                        <strong>"<%- els.get("billerShortName")%>"</strong>  as a beneficiary.</p>
											<!--<p><%-$.i18n.t('app.transfer.managebeneficiary.sucessmsg2')%><%- els.get("coolingPeriod")%></p>-->
	                                    <br/>
                                    <% }  else {%>
                                    	<p>You have successfully added Customer No :
	                                        <strong>"<%- els.get("addBillerCustomerNumber")%>"</strong>  as a beneficiary.</p>
	                                    <br/>
                                    <% } %>
                                    <div class="clearfix"></div>
									<div class="row">
              							<div class="col-xs-6 pr5"><button type="button" id="addAnotherBillerBtn" class="btn btn-default btn-block"><%-$.i18n.t('app.transfer.managebeneficiary.addbene')%></button></button></div>
          								<div class="col-xs-6 pl5"><button type="button" class="btn btn-default btn-block" id="viewBillersBtn"><%-$.i18n.t('app.transfer.managebeneficiary.viewbeneficiaries')%></button></div>
            						</div>	
            						<br/>
            						<div class="row">
            							<div class="col-xs-3 pr5"></div>
            							<div class="col-xs-6 pr5"><button type="button" id="initTransferBillerSuccess" class="btn btn-default btn-block"><%-$.i18n.t('app.transfer.managebeneficiary.initiatetransfer')%></button></div>
            							<div class="col-xs-3 pr5"></div>
            						</div>	                      
                                </div>
                            </div>
