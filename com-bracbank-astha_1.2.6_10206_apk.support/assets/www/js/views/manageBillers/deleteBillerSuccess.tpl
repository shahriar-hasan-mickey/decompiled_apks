						...
						<div class="container" style="padding-left:0; padding-right:0;">
							...
							<div class="ani-slideup animation-in">
								...
								<div class="text-center">
									...
									<div class="row">
										<div class="col-xs-6 pr5"><button type="button" id="deleteBiller_AddBillerBtn" class="btn btn-default btn-block">Add Beneficiary</button></div>
										<div class="col-xs-6 pl5"><button type="button" id="deleteBiller_ViewBillerBtn" class="btn btn-default btn-block">View Beneficiaries</button></div>
									</div>			  
								</div>
							</div>
						</div>
