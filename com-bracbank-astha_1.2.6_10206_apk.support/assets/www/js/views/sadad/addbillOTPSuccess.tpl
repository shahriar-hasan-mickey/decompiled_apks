  <%
	...
	console.log("add_managebill_details",add_managebill_details[4]);
%>
 ...
 <div class="dtl_view">
		 <form>
		        <div class="alert alert-success text-center">
		                <p><%-$.i18n.t('app.sadad.managebills.addbillmessage')%><%-$.i18n.t('app.transfer.standinginstruction.refno')%> <%-refNumber%></p>
		                ...
		                <p><b><%-$.i18n.t('app.sadad.managebills.addbillmessage3')%></b></p> -->
		                    ...
		                    <a href="#/addnewbill" class="btn btn-success btn-block" ><%-$.i18n.t('app.sadad.managebills.addanotherbill')%></a>
