									        	...
									        	<div class="smsotp_block"  id="smsDivId">
																...
																<div class="form-group">
																	<div class="input-group">
																		...
																		<%}else{%>
																		<input type="password" autocomplete='off'  pattern="[0-9]*" inputmode="numeric" class="form-control lenthcontrolotpnumval"  maxlength="6" id="otp" name="otp" placeholder="<%-$.i18n.t('app.creditcard.ccpayments.enterotp')%>">
																		<%}%>
