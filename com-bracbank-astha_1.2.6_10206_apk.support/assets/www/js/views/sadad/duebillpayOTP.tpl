...
<input type="hidden" name="isformloaded" id="isformloaded" value="<%-soft_token%>" />
							        <div id="otpId">	
													...
													<% } %>
														<div class="smsotp_block" style="display: none;" id="smsDivId">
																...
																<div class="form-group">
																	...
																	<%}else{%>
																		<input type="number" autocomplete='off'  pattern="[0-9]*" inputmode="numeric" id="otp" name="otp" maxlength="6" placeholder="<%-$.i18n.t('app.sadad.managebills.enterotp')%>" class="form-control lenthcontrol">
																	<%}%>
						                        ...
						                        <a href="#/duebillpay" class="btn btn-primary btn-block"><%-$.i18n.t('app.creditcard.ccpayments.cancel')%></a>
							        </div>
 </form></div><br/>
