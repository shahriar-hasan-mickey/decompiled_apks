...
<input type="hidden" name="isformloaded" id="isformloaded" value="<%-soft_token%>" />
				<div id="otpId">	
								...
								<div class="form-group paymentMode">
									...
									<div data-toggle="buttons" class="btn-group btn-group-justified">
										<label class="btn btn-default smsotp" id="labeloption">
											<input type="radio" id="option1" value="otp" name="option1"><%-$.i18n.t('app.creditcard.ccpayments.smsotp')%> 
										</label>
										<label class="btn btn-default softToken" >
											<input type="radio" id="option2" value="softotp"  name="option2"><%-$.i18n.t('app.creditcard.ccpayments.softtoken')%>  
										</label>
									</div>
								</div>
								<% } %>	
                  ...
                  <a href="#/oneTimePay" class="btn btn-primary btn-block"><%-$.i18n.t('app.creditcard.ccpayments.cancel')%></a>
        	</div>
 </form></div><br/>
